...
<center>
<h2>Detalle Cartera Responsabilidad Bienes</h2>
...
<table width="780" border="0">
 ...
 <td><input type="text" id="tipo_acuerdo" style="width : 91%;" readonly="readonly" ></td>
    ...
    <td>&nbsp;</td>	
    <td><b>Codigo Bien</td>
    <td><input type="text" id="id_bien" name="id_bien" style="width : 91%;" value="<?=$carteras["COD_TIPO_ACTIVO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Descripción Bien</td>
    <td><input type="text" id="desc_bien" name="desc_bien" style="width : 91%;" readonly="readonly" value="<?=$carteras["NOMBRE_TIPOACTIVO"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
   	       <tr>
    <td>&nbsp;</td>	
    <td><b>Placa Inventario</td>
    <td><input type="text" id="placa_inv" name="placa_inv" style="width : 91%;" readonly="readonly" value="<?=$carteras["PLACA_INVENTARIO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Regional Bien</td>
    <td><input type="text" id="regional_bien" name="regional_bien" style="width : 91%;" readonly="readonly" value="<?=$carteras["REGIONAL_BIEN"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
     	       <tr>
    <td>&nbsp;</td>	
    <td><b>Motivo Dado de Baja</td>
    <td><input type="text" id="motivo_baja" name="motivo_baja" style="width : 91%;" value="<?=$carteras["MOTIVO_DADO_BAJA"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Fecha Dado de Baja</td>
    <td><input type="text" id="fecha_baja" name="fecha_baja" style="width : 91%;" readonly="readonly" value="<?=$carteras["FECHA_BAJA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
     	       <tr>
    <td>&nbsp;</td>	
    <td><b>Valor Compra</td>
    <td><input type="text" id="valor_compra" name="valor_compra" style="width : 91%;" readonly="readonly" value="<?=number_format($carteras["VALOR_COMPRA"], 0, ',', '.')?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Valor Depreciación</td>
    <td><input type="text" id="valor_dep" name="valor_dep" style="width : 91%;" readonly="readonly" value="<?=number_format($carteras["VALOR_DEPRECIADO"], 0, ',', '.')?>"></td>
  	<td>&nbsp;</td>
  </tr>
  
       	       <tr>
    <td>&nbsp;</td>	
    <td><b>Valor por Depreciar</td>
    <td><input type="text" id="valor_x_depreciar" name="valor_x_depreciar" readonly="readonly" style="width : 91%;" value="<?=number_format($carteras["VALOR_COMPRA"]-$carteras["VALOR_DEPRECIADO"], 0, ',', '.')?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Valor Deducible</td>
    <td><input type="text" id="valor_deducible" name="valor_deducible" style="width : 91%;" readonly="readonly" value="<?=number_format($carteras["VALOR_DEDUCIBLE"], 0, ',', '.')?>"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>	
