...
<center><h3>RESPONSABILIDAD ADMINISTRATIVA DE BIENES</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_responsabilidad_bienes/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>

<form id="edicion_cartera" action="<?= base_url('index.php/cnm_responsabilidad_bienes/creacion') ?>" method="post" >
