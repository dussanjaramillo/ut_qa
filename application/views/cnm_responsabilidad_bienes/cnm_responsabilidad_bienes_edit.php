...
<center>
<h2>Edición Cartera Responsabilidad Bienes</h2>
...
<td><input type="text" id="tipo_acuerdo_id" name="tipo_acuerdo_id" style="width : 91%;" readonly="readonly" disabled="disabled"></td>
 ...
 ?> 
    ...
    <td>&nbsp;</td>	
    <td>Codigo Bien</td>
    <td><input type="text" id="id_bien" name="id_bien" style="width : 91%;" value="<?=$detalleCart["COD_TIPO_ACTIVO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Descripción Bien</td>
    <td><input type="text" id="desc_bien" name="desc_bien" style="width : 91%;" readonly="readonly" value="<?=$detalleCart["NOMBRE_TIPOACTIVO"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
   	       <tr>
    <td>&nbsp;</td>	
    <td>Placa Inventario</td>
    <td><input type="text" id="placa_inv" name="placa_inv" style="width : 91%;" value="<?=$detalleCart["PLACA_INVENTARIO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Regional Bien</td>
    <td><input type="text" id="regional_bien" name="regional_bien" style="width : 91%;" readonly="readonly" value="<?=$detalleCart["NOMBRE_REGIONAL_BIEN"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
     	       <tr>
    <td>&nbsp;</td>	
    <td>Motivo Dado de Baja</td>
    <td><input type="text" id="motivo_baja" name="motivo_baja" style="width : 91%;" value="<?=$detalleCart["MOTIVO_DADO_BAJA"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Fecha Dado de Baja</td>
    <td><input type="text" id="fecha_baja" name="fecha_baja" style="width : 91%;" readonly="readonly" value="<?=$detalleCart["FECHA_BAJA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
     	       <tr>
    <td>&nbsp;</td>	
    <td>Valor Compra</td>
    <td><input type="text" id="valor_compra" name="valor_compra" style="width : 91%;" value="<?=number_format($detalleCart["VALOR_COMPRA"], 0, ',', '.')?>"  readonly="readonly" ></td>
    <td>&nbsp;</td>
    <td>Valor Depreciación</td>
    <td><input type="text" id="valor_dep" name="valor_dep" style="width : 91%;" readonly="readonly" value="<?=number_format($detalleCart["VALOR_DEPRECIADO"], 0, ',', '.')?>"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="valor_x_depreciar" name="valor_x_depreciar" style="width : 91%;" value="<?=number_format($detalleCart["VALOR_COMPRA"]-$detalleCart["VALOR_DEPRECIADO"], 0, ',', '.')?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Valor Deducible</td>
    <td><input type="text" id="valor_deducible" name="valor_deducible" style="width : 91%;" readonly="readonly" value="<?=number_format($detalleCart["VALOR_DEDUCIBLE"], 0, ',', '.')?>"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>	
