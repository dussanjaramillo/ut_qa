        ...
        if (informacion == "" || nombre == "" || comentarios == "") {
            ...
            $.post(url, {nombre2: nombre, nombre: nombre_archivo, informacion: informacion, opcion: "1", fiscalizacion: fiscalizacion,asignar:<?= $coordinador ?>})
                    .done(function(msg) {
                        ...
                        $.post(url_documentos, {encabezado: encabezado, abogado: abogado, coordinador: coordinador, cod_fiscalizacion: fiscalizacion, estado: estado, secretario: secretario, nombre_documento: nombre_archivo, comentarios: comentarios,asignar:<?= $coordinador ?>})
                                .done(function(msg) {
