...
<div style="width: 90%; border-color: black; border: 1px solid grey; margin: auto; overflow: hidden;alignment-adjust: central ;padding: 15px 50px 0">
    ...
    <b>Abogado de Relaciones Corporativas: </b><?php echo $nombre_a; ?><br>
    <b>Coordinador de Relaciones Corporativas: </b><?php echo $nombre_s; ?><br>
    <br>
</div>
<br>
<div  style="width: 90%; border-color: black; border: 1px solid grey; margin: auto; overflow: hidden;alignment-adjust: central ;padding: 15px 50px 0">
...
<script>
    ...
    $('#enviar').click(function() {
        ...
        if (informacion == "" || nombre == "" || comentarios == "") {
            ...
            var url = '<?php echo base_url('index.php/acuerdopagodoc/guardar_archivo') ?>';
            var url_documentos = '<?php echo base_url('index.php/acuerdopagodoc/insertar_comunicacion') ?>';
            var nombre_archivo = "<?php echo date("d-m-Y H:i:s"); ?>";
            nombre_archivo = nombre_archivo.replace(":", "_");
            nombre_archivo = nombre_archivo.replace(":", "_");
            nombre_archivo = nombre_archivo.replace(" ", "_");
            nombre_archivo = nombre_archivo + "_" + nombre;
            $.post(url, {nombre2: nombre, nombre: nombre_archivo, informacion: informacion, opcion: "1", fiscalizacion: fiscalizacion,asignar:<?= $coordinador ?>})
                    .done(function(msg) {
                        nombre_archivo = nombre_archivo + ".txt";
                        $.post(url_documentos, {encabezado: encabezado, abogado: abogado, coordinador: secretario, cod_fiscalizacion: fiscalizacion, estado: estado, secretario: secretario, nombre_documento: nombre_archivo, comentarios: comentarios,asignar:<?= $abogado ?>})
                                .done(function(msg) {
