...
<div style="background: #f0f0f0; width: 90%; margin: auto; overflow: hidden">
    ...
    echo form_open("prescripcion", $attributes);
    ?>       
    <br>
    ...
    <div class="notificacion_1" style="overflow: hidden; width: 90%; margin: 0 auto">
        <br>
        <h2 class="text-center">Enviar Notificacion de la Resolución Via Email</h2>    
        <br><br>
        <div  style="width: 80%; border-color: black; border: 1px solid grey; margin: auto; overflow: hidden;alignment-adjust: central ;padding: 15px 50px 0">
            <?php
            $ruta = base_url('uploads/prescripcion/' . $cod_coactivo . '/Expediente/' . $anexo["NOMBRE_DOCUMENTO"]);
            echo '<br>';
            echo form_label('<b>Archivo Adjunto </b><span class="required"></span>', 'lb_archivo');
            echo '<a href="' . base_url('uploads/prescripcion/' . $cod_coactivo . '/Expediente/' . $anexo["NOMBRE_DOCUMENTO"]) . '">' . $anexo["NOMBRE_DOCUMENTO"] . '</a>';
            echo '<br><br>';
    ...
    <script>
        ...
        $('#enviar').click(function() {
            ...
            var url_correo = '<?php echo base_url('index.php/resolucionprescripcion/Enviar_Correo') ?>';
