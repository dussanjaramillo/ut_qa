...
<center>
<h2>Reliquidación de Credito</h2>
 <?php     
...
<tr>
  ...
  <td colspan="7"><hr width=100% align="center" style="background-color: black;  height: 1px;" ></td>
    ...
    <td><?php
          ...
          echo form_dropdown('motivo_id', $selectmotivo,'','id="motivo_id" style="width : 86%;" class="chosen" data-placeholder="seleccione..." ');
         
           echo form_error('motivo_id','<div>','</div>');
           ?></td>    
	<td>&nbsp;</td>
    <td>Fecha Retiro</td>
    <td><input type="text" id="nueva_f_r" onchange ="presubmit();" name="nueva_f_r" style="width : 80%;" readonly="readonly"></td>
...
<?php
          ...
          echo form_dropdown('reliq_combo_tipo_tasa_corriente', $selecttipotasa,'','id="reliq_combo_tipo_tasa_corriente" onchange ="presubmit();" style="width : 34%;" readonly="readonly" disabled="disabled" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="reliq_porcent_tasa_c" name="reliq_porcent_tasa_c" onchange ="presubmit();" style="width : 15%;" required="required">%
    	<?php
          ...
          echo form_dropdown('reliq_aplica_tasa_c', $selecttasacorriente,'','id="reliq_aplica_tasa_c" style="width : 30%;" class="chosen" onchange ="presubmit();" data-placeholder="seleccione..." ');
    ...
    <td>
    	<?php
          ...
          echo form_dropdown('reliq_combo_tipo_tasa_mora', $selecttipotasa,'','id="reliq_combo_tipo_tasa_mora" required="required" onchange ="presubmit();" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="reliq_porcent_tasa_m" name="reliq_porcent_tasa_m" onchange ="presubmit();" style="width : 15%;" required="required">%
    	<?php
          ...
          echo form_dropdown('reliq_aplica_tasa_m', $selecttasamora,'','id="reliq_aplica_tasa_m" style="width : 30%;" onchange ="presubmit();" required="required" class="chosen" data-placeholder="seleccione..." ');
    ...
    <td>&nbsp;</td>
    <td>Fecha Reliquidación</td>
    <td><input type="text" id="fecha_reliq" name="fecha_reliq" style="width : 80%;" readonly="readonly" onchange ="presubmit();"></td>
    <td>&nbsp;</td> 
  </tr>
...
$( "#fecha_reliq").datepicker({
	
	showOn: 'button',
	buttonText: 'Fecha Reliquidación',
	buttonImage: '<?php echo base_url() . "img/calendario.png" ?>',
	buttonImageOnly: true,
	numberOfMonths: 1,
	changeMonth: true,
...
function confirmSubmit() {
  if (confirm("Esta seguro de reliquidar la Cartera?")) {
     return true;
  }
  return false;
}
