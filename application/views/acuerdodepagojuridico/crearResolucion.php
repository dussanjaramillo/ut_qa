    ...
    $('#comentarios').val(comentarios);
      ...
      $('#guardar').click(function(){
            ...
            if (valida == true){
                ...
                $.post(url,{acuerdo:<?= $acuerdo ?>,estado:<?= $estado ?>,cod_coactivo:'<?= $cod_coactivo ?>',nit:<?= $nit ?>,onbase:onbase,fechanotificacion:fechanotificacion,notificacion:notificacion,Titulo_Encabezado:Titulo_Encabezado,comentarios:comentarios})
                .done(function(data){
                    $('.conn').html(data);
