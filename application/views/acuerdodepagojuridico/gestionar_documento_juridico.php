...
<div>
    <table width='100%'>
        <tr>
            ...
            <td><input type="checkbox" name="resolucion" id="resolucion2"></td>
            <td>CITACIÓN</td>
        ...
        <tr>
            ...
            <td><input type="checkbox" name="liquidacion" id="liquidacion2"></td>
        </tr>
        <tr>
...
<form action="<?php echo base_url('index.php/acuerdodepago/guardar_paso_juridico'); ?>" method="post" onsubmit="return  correccion()" id="form1">
...
<script>
    ...
    $('#ver_documentos').click(function() {
        ...
        $('#resultado_documento').show();
    });
    $('#documento').click(function() {
        var resolucion = $('#resolucion2').is(':checked');
        ...
        var liquidacion = $('#liquidacion2').is(':checked');
        var id = '<?php echo $post['id']; ?>';
        var cod_fis = '<?php echo $post['cod_fis']; ?>';
        $(".preload, .load").show();
        var url = '<?php echo base_url('index.php/acuerdodepago/documentacion'); ?>';
        $.post(url, {liquidacion:liquidacion,cod_fis: cod_fis, id: id, resolucion: resolucion, citacion: citacion, 
         recurso: recurso, ejecutoria: ejecutoria, revocatoria: revocatoria})
                .done(function(msg) {
                    //alert(msg.total);
    ...
    $('#generar2').click(function() {
        ...
        $.post(url, {cod_fis: cod_fis, id: id, nit: nit, informacion: informacion})
                .done(function() {
