<form id="form_volver" action="<?= base_url('index.php/acuerdodepagojuridico/Gestion_EliminarPlantillas') ?>" method="post" >
...
<form id="form1" action="<?= base_url('index.php/acuerdodepagojuridico/Gestion_EliminarSoporte') ?>" method="post" >
...
echo form_open_multipart("acuerdodepagojuridico/Generar_Expediente", $attributes);
