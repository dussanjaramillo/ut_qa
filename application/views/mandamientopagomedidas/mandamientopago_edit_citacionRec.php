<?php 
/**
 * mandamientopago_edit -- Vista para editar citacion de recurso para notificacion personal.
 *
...
<!-- <div class="center-form"> -->
        ...
        <center>
        <h2>Notificaci&oacute;n personal</h2>
        </center>
        ...
        <tr id="cargColilla" style="display:none">
            ...
            <td align="left">
                ...
                <div class="span3">
                    ...
                    $cRuta .= "mandamientos/citacionRec/";                    
                    //echo $cRuta."<br>";
...
<div id="ajax_load" class="ajax_load" style="display: none">
  ...
  $(document).ready(function() {
    ...
    $('#pdf').click(function() {
        ...
        $('#citacionFrm').submit();
        $('#citacionFrm').attr("action", "citacionFrm");
    });    
