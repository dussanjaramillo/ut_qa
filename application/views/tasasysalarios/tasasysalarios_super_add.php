...
<div class="center-form">
        ...
        <h2>Actualizar Tasa de superintendencia</h2>
       
        <p>
        <?php
         echo form_label('Tasa Superintendencia<span class="required">*</span>', 'tasasuper');
         $data = array(
                    'name'        => 'tasasuper',
                    'id'          => 'tasasuper',
                    'value'       => set_value('tasasuper'),
                    'maxlength'   => '10',
                    'class'       =>  'input-mini'
                  );
         ...
         echo form_error('tasasuper','<div>','</div>');
        ?>
