...
<?php echo form_hidden('id',$result->COD_MOTIVO_DEVOLUCION) ?>
<h2>Editar Motivo Devolución</h2>
<p>
        <?php
         echo form_label('Nombre Motivo Devolución<span class="required">*</span>', 'nombremotivo');
           $dataid = array(
                      'name'        => 'nombremotivo',
                      'id'          => 'nombremotivo',
                      'value'       => $result->MOTIVO_DEVOLUCION,
                      'maxlength'   => '128',
                      'required'    => 'required'
                    );
...
<script>
    ...
    $("#borrar").click(function(evento){    
        ...
        $( "#dialog-confirm" ).dialog({
            ...
            buttons: {
                "Confirmar": function() {
                    location.href='<?php echo base_url()."index.php/motivodevolucion/delete/".$result->COD_MOTIVO_DEVOLUCION; ?>';
...
<div id="dialog-confirm" title="¿Eliminar el Motivo de devolución?" style="display:none;">
    <p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>¿Confirma que desea eliminar el motivo de devolución "<?php echo $result->MOTIVO_DEVOLUCION; ?>"?</p>
</div>