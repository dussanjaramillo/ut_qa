<?php 
/**
 * mandamientopago_edit -- Vista para editar citacion para notificacion personal.
 *
...
<!-- <div class="center-form"> -->
        <?php     
        $data = $result;        
        $attributes = array('id' => 'paginaFrm', 'name' => 'paginaFrm',
            'class' => 'form-inline', 
            'method' => 'POST', 
        ...
        <center>
        <h2>Notificaci&oacute;n en p&aacute;gina Web del SENA</h2>
        </center>
...
<div id="ajax_load" class="ajax_load" style="display: none">
  ...
  $(document).ready(function() {
    ...
    $('#pdf').click(function() {
        ...
        $('#paginaFrm').attr("action", "pdf");
        $('#paginaFrm').submit();
        $('#paginaFrm').attr("action", "citacion");
    });    
   ...
   function comprobarextension() {
    ...
    function f_DeleteAdj(xRuta) {
        if (confirm('¿Esta seguro de Eliminar el archivo?')) {
            document.forms['paginaFrm']['vRuta'].value=xRuta;
            document.forms['paginaFrm']['vUbicacion'].value="pagina";
            document.forms['paginaFrm'].action="delFile";
            document.forms['paginaFrm'].submit();
            document.forms['paginaFrm'].action="pagina";
        }
    }
