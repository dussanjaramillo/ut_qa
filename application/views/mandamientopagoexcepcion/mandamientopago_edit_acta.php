<?php 
/**
 * mandamientopago_edit -- Vista para editar acta para excepcion notificacion personal.
 *
...
<!-- <div class="center-form"> -->
        ...
        <center>
        <h2>Acta de Notificaci&oacute;n personal de excepci&oacute;n</h2>
        </center>
      ...
      $('#guardar').click(function() {
        ...
        switch (estado){
            ...
            case "2":
                    ...
                    var anoonb = parseInt(fechaonb.split("/")[2]);
                    var mesonb = parseInt(fechaonb.split("/")[1]) -1;
                    var diaonb = parseInt(fechaonb.split("/")[0])
                    var anonot = parseInt(fechanot.split("/")[2]);
                    var mesnot = parseInt(fechanot.split("/")[1]) -1;
                    var dianot = parseInt(fechanot.split("/")[0])
                    var fechaonbase = new Date(anoonb, mesonb, diaonb);
                    var fechanotify = new Date(anonot, mesnot, dianot);
