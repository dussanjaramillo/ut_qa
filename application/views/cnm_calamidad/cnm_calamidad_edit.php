...
<center>
<h2>Edición Cartera Calamidad Doméstica</h2>
...
<td>    	 
 ...
 ?> 
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
    <td><input type="text" id="plazo" onchange ="presubmit();" name="plazo" style="width : 15%;" required="required" value="<?=$detalleCart["PLAZO_CUOTAS"]?>">
    ...
    {?>
    	...
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,$detalleCart["TIPO_T_V_CORRIENTE"],'id="aplica_tasa_c" style="width : 30%;" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
