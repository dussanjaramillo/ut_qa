...
<center>
<h2>Registro Cartera Calamidad Doméstica</h2>
...
<td>    	 
 ...
 ?> 
    ...
    <td><input type="text" id="fecha_solicitud" name="fecha_solicitud" style="width : 84%;" readonly="readonly" required="required"></td>
  	<td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
...
<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,'','id="combo_tipo_tasa_corriente" readonly="readonly" disabled="disabled" onchange ="presubmit();" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td><input type="text" id="nombre_codeudor" name="nombre_codeudor" style="width : 91%;" onkeypress ="escape(this);" onblur = "escape(this);" onkeyup = "escape(this);"></td>
    <td>&nbsp;</td>
  </tr> 
...
$( "#fecha_solicitud").datepicker({
	...
	maxDate: "-1",
      minDate: "-5y",
        ...
        $("#fecha_resolucion").datepicker("option", "minDate", selectedDate);
        $("#fecha_activacion").datepicker("option", "minDate", selectedDate);
      }
...
id_codeudor = document.getElementById("id_codeudor").value;
 	    if( !(/[A-z-\/\*\,\.\ \;\:\{\}\[\]\^\`\¨\´\+\~\°\|\¬\!\¡\'\?\¿\=\)\(\&\%\$\#\"\<\>\Ñ\ñ\+]/.test(id_codeudor)) )
		{}
  else{
$('#id_codeudor').val("");
  }
