...
<center><h3>CALAMIDAD DOMÉSTICA</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_calamidad/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_calamidad/edit') ?>" method="post" >
