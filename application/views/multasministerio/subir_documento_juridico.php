...
echo form_open_multipart("multasministerio/documento_juridico", $attributes);
?>
...
<div >            
    ...
    <input type="hidden" id="cod_multa" name="cod_multa" value="<?php echo $post['cod_multa'] ?>">
    <input type="hidden" id="nresol" name="nresol" value="<?php echo $post['nresol'] ?>">
