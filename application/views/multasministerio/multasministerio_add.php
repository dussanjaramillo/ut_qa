...
$nradicado  = array('name'=> 'nradicado','id'=>'nradicado','value'=>set_value('nradicado'),'maxlength'=>'12','required'=>'required','autofocus'=>"true",'onchange'=>"numerico('nradicado')");
$nis        = array('name'=> 'nis','id'=>'nis','value'=>set_value('nis'),'maxlength'=>'10','required'=>'required','onchange'=>"numerico('nis')");
$nresol     = array('name'=> 'nresol','id'=>'nresol','value'=>set_value('nresol'),'maxlength'=>'15','required'=>'required','readonly'=>'readonly');
$valor      = array('name'=> 'valor','id'=>'valor','value'=>set_value('valor'),'maxlength'=>'15','required'=>'required','readonly'=>'readonly');
...
$pinicial   = array('name'=> 'pinicial','readonly'=>'readonly','id'=>'pinicial','required'=>'true','value'=>set_value('pinicial'));
//$pfinal     = array('name'=> 'pfinal','id'=>'pfinal','required'=>'true','value'=>set_value('pfinal'));
$fejecutoria= array('name'=> 'fejecutoria','readonly'=>'readonly','id'=>'fejecutoria','required'=>'true','value'=>set_value('fejecutoria'));
...
$fisc       = array('name'=> 'fisc','id' => 'fisc','type'=>'hidden','value'=>(isset($post['fisc'])?$post['fisc']:''));
?>
...
<div class="center-form-large" >
    <?= form_open_multipart(base_url('index.php/multasministerio/add'),array('class'=>'validar_form'));?>
...
?>
    <table>
        ...
        <tr>
            <td><?= form_label('Fecha Resolución', 'pinicial',$attributes);?></td>
...
<!--            <td><?= form_label('Período Final', 'pfinal',$attributes);?></td>
        ...
        <tr>
            ...
            <td><?= form_input($nresol);?><?=form_error('nresol','<div>','</div>');?>
                <button href='#' id="btn_resol" data-toggle="modal" data-target="#modal3" data-keyboard="false" data-backdrop="static" title="Respuesta Auto" class="btn btn-default" style="position: relative;float: left;">Cargar Resolución...</button></td>
  ...
  <div class="modal hide fade in" id="modal3" style="display: none; width: 60%; margin-left: -30%;">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">Cargar Resolución</h4>
        </div>
