        ...
        <h2>Estado Mandamiento de pago</h2>        
            <div id='dialog'>
                ...
                <input type='text' id='cod_fiscalizacion' name='cod_fiscalizacion' value='<?= $fiscalizacion ?>'>
...
<script>    
    $(document).ready(function() { 
        ...
        var cod_fiscalizacion = $("#cod_fiscalizacion").val();
        var url1 = $("#url1").val();
        var url2 = $("#url2").val();
...
//        var ruta = "<?php echo base_url("index.php/tiempos/bloqueo"); ?>";
        ...
        $("#dialog").dialog({
                buttons: [{
                    ...
                    click: function() {
                        $(".ajax_load").show("slow");
                        $.post(url2,{gestion : gestion, clave : mandamiento, nit: nit, cod_fiscalizacion:cod_fiscalizacion},function(data){                           
