...
<script>
    ...
    $('.actuar').click(function() {
        if (this.value == 1) {
                ...
                if (cod_siguiente == "<?php echo MUEBLE_FAVORABLE; ?>") {
                    var dato = "<?php echo MUEBLE_INSISTIR; ?>";
                } else if (cod_siguiente == "<?php echo INMUEBLE_FAVORABLE; ?>") {
                    var dato = "<?php echo INMUEBLE_INSISTIR; ?>";
                } else  if (cod_siguiente == "<?php echo VEHICULO_FAVORABLE; ?>") {
                    var dato = "<?php echo VEHICULO_INSISTIR; ?>";
                } else{
                    return false;
                }
                enviar(dato);
