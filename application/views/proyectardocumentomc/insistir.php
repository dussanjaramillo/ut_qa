...
<script>
    ...
    $('.actuar').click(function() {
        if (this.value == 1) {
            if (cod_siguiente == "<?php echo MUEBLE_INSISTIR; ?>") {
                var dato = "<?php echo MUEBLES_DOCUMENTO_ACTA_SUBIR_ARCHIVO; ?>";
            } else if (cod_siguiente == "<?php echo INMUEBLE_INSISTIR; ?>") {
                var dato = "<?php echo INMUEBLES_DOCUMENTO_ACTA_SUBIR_ARCHIVO; ?>";
            }else if (cod_siguiente == "<?php echo VEHICULO_INSISTIR; ?>") {
                var dato = "<?php echo VEHICULO_DOCUMENTO_ACTA_SUBIR_ARCHIVO; ?>";
            }else{
                return false;
            }
            enviar(dato);
