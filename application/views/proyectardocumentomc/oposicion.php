...
<script>
    ...
    $('.actuar').click(function() {
        if (this.value == 1) {
            if (cod_siguiente == "<?php echo MUEBLE_OPOSICION; ?>") {
                var dato = "<?php echo MUEBLES_PROYECTAR_AUTO_INICIO; ?>";
            } else  if (cod_siguiente == "<?php echo INMUEBLE_OPOSICION; ?>") {
                var dato = "<?php echo INMUEBLES_PROYECTAR_AUTO_INICIO; ?>";
            }else if (cod_siguiente == "<?php echo VEHICULO_OPOSICION2; ?>") {
                var dato = "<?php echo VEHICULO_PROYECTAR_AUTO_INICIO;//VEHICULO_OPOSICION_INICIO; ?>";
            }else{
                return false;
            }
            enviar(dato);
        } else if (this.value == 2) {
            if (cod_siguiente == "<?php echo INMUEBLE_OPOSICION; ?>") {
                var dato = "<?php echo VIKY_OPOSICION; ?>";
            } else if (cod_siguiente == "<?php echo MUEBLE_OPOSICION; ?>") {
                var dato = "<?php echo VIKY_OPOSICION; ?>";
            } else if (cod_siguiente == "<?php echo VEHICULO_OPOSICION2; ?>") {
                var dato = "<?php echo VIKY_OPOSICION; ?>";
            } else {
