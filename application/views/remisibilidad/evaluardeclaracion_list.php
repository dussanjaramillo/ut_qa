<br><div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    if (isset($message)) {
        ...
        echo "seleccione la empresa a verificar";
    }
    ?>
</div>
<div class="preload"></div><img class="load" src="<?php echo base_url('img/27.gif'); ?>" width="128" height="128" />
<br><br>
<h1>REMISIBILIDADES SIN VERIFICAR CONDICIONES</h1>
<br>
<br><br>
<table id="tablaq">
    <thead>
...
<form id="form1" action="<?= base_url('index.php/remisibilidad/Generar_FichaCondiciones') ?>" method="post" >
