<form id="form_volver" action="<?= base_url('index.php/remisibilidad/Gestion_EliminarPlantillas') ?>" method="post" >
...
<form id="form1" action="<?= base_url('index.php/remisibilidad/Gestion_EliminarSoporte') ?>" method="post" >
