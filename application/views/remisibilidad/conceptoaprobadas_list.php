<br><div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button>
    ...
    if (isset($message)) {
        ...
        echo "Seleccione la empresa a emitir el concepto";
    }
    ?>
</div>
<div class="preload"></div><img class="load" src="<?php echo base_url('img/27.gif'); ?>" width="128" height="128" />
<br><br>
<h1>EMITIR CONCEPTO DE REMISIBILIDAD</h1>
<br>
<br><br>
<table id="tablaq">
    <thead>
...
<form id="form1" action="<?= base_url('index.php/remisibilidad/Agregar_Concepto_Remisibilidad') ?>" method="post" >
