...
<center>
    ...
    <div class="Boton_Agregar">
        <?php
        echo form_button($data_6) . "  " . form_button($data_5) . "  " . form_button($data_1) . "  " . form_button($data_4) . "  " . form_button($data_7);
        ?>
    </div>
    <div class="Boton_PDF">
        <?php
        echo form_button($data_6) . "  " . form_button($data_5) . "  " . form_button($data_3) . "  " . form_button($data_4) . "  " . form_button($data_7);
        ?>
    </div>
