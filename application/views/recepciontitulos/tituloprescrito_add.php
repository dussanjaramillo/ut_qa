...
<div style="background: #f0f0f0; width: 700px; margin: auto; overflow: hidden">
    ...
    echo form_open("recepciontitulos/Titulo_Prescrito", $attributes);
    ?>       
    <?php
    ...
    <div style="overflow: hidden; width: 80%; margin: 0 auto">
        <h2 class="text-center">Registrar si el titulo ha prescrito</h2>
    </div>
    <div style="overflow: hidden; width: 70%; margin: 0 auto">
        ...
        <div class="columna_izquierda">                                    
            <?php echo form_radio($data, '1',"checked") . "Titulo Prescrito"; ?>
        </div>
        <div class="columna_derecha">  
            <?php echo form_radio($data, '2') . "Titulo Vigente"; ?>    
        </div>
        <br><br><br>
    </div>
    <div style="overflow: hidden; width: 35%; margin: 0 auto">
        ...
        ?>
        <?php echo anchor('recepciontitulos/Menu_TituloPrescrito', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
    </div>
