...
<div style="background: #f0f0f0; width: 700px; margin: auto; overflow: hidden">
    ...
    <div style="overflow: hidden; width: 80%; margin: 0 auto">
        <h2 class="text-center">Registrar si el titulo esta proximo a prescribir</h2>
    </div>
    <div style="overflow: hidden; width: 70%; margin: 0 auto">
        ...
        <div class="columna_izquierda">                                    
            <?php echo form_radio($data, '1',"checked") . "Es Proximo a Prescribir"; ?>
        </div>
        <div class="columna_derecha">  
            <?php echo form_radio($data, '2') . "No Es Proximo a Prescribir"; ?>    
        </div>
        <br><br><br>
    </div>
    <div style="overflow: hidden; width: 35%; margin: 0 auto">
        ...
        ?>
        <?php echo anchor('recepciontitulos/Menu_TituloProximoPrescribir', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
    </div>
