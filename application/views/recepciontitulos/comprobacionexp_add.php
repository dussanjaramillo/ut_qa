<form id="form_volver" action="<?= base_url('index.php/recepciontitulos/Gestion_EliminarPlantillas') ?>" method="post" >
...
<form id="form1" action="<?= base_url('index.php/recepciontitulos/Gestion_EliminarSoporte') ?>" method="post" >
