...
<center><h3>CUOTA PARTE PENSIONAL</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_cuota_parte/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_cuota_parte/edit') ?>" method="post" >
...
$(document).ready(function(){
	$('.atcoactivo').click(function() {
		var atcoactivo=$(this).attr('atcoactivo');
		var attipo=$(this).attr('attipo');
