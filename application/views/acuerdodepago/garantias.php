...
if (!empty($datosgarantia)) {
    echo "<table border='2' id='table_existe'>";
...
<form id="formgarantia" method="post">
    ...
    <input type="hidden" value="<?= $fiscalizacion ?>" name="fiscalizacion" id="fiscalizacion">    
    <input type="hidden" value="<?= $liquidacion ?>" name="liquidacion" id="liquidacion">  
    <input type="hidden" value="<?= $resolucion ?>" name="resolucion" id="resolucion">  
    ...
    <div id="ingresodegarantia">
        ...
        <table id="tablagarantias">
            <tr>
                ...
                <th align='center'>Valor Avaluo</th>
            </tr>
            <tr id="clongarantia">
                <td>
...
$('.eliminar').click(function(){
    ...
    var url = "<?= base_url('index.php/acuerdodepago/eliminargarantia')  ?>";
...
//---------------------------------------------------------------------------------
    ...
    $('#guardar').click(function() {
        $(".ajax_load").show("slow");        
            ...
            if(i == 0){
                $(".ajax_load").show(); 
                var url = "<?= base_url("index.php/acuerdodepago/guardagarantiaingreso") ?>";
    ...
    $('.otrasgarantias').on("change", function() {
        ...
        var url = "<?= base_url("index.php/acuerdodepago/muestrahtmlcamposgarantias") ?>";
