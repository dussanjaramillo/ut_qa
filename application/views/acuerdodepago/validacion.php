...
<table align="center">
    ...
    <tr>
     ...
     <table align="center" id="rectificacion" style="display:none">
        <tr>
            <td>EL CLIENTE PERTENECE A LA LISTA DE DEUDORES MOROSOS</td>
            <td>
    ...
    <form id="f1" method="post" enctype="multipart/form-data" >
        <table id="subidaarchivo" align="center" style="display:none"></table>    
            <table align="center" id="boton_adjuntar" style="display:none">
                <tr>
                    <td><button type="button" id="atras" class="btn btn-success">Atras</button></td>
...
<script>
   ...
   $('#validar').click(function() {
    ...
    if (autorizacion == ''){
        ...
        if (autorizacion == 1){                        
                $.post(url, {observacion: observacion, fiscalizacion: fiscalizacion, nit:nit, autorizacion:autorizacion, acuerdo:acuerdo, cantSolicitudes:cantSolicitudes}, function(data) {
