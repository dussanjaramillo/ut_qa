...
<table align="center">
    ...
    <tr>
        <td colspan="2" align="right"><button type="button" id="guardargarantia" class="clon btn btn-success">Crear</button></td>
                    ...
                    <form name="form1" id="form1" method="post" action="<?php echo base_url().'index.php/acuerdodepago/eliminar_garantias'?>">
                    <table id="estilogarantia">
                        ...
                        <tbody>
                            <?php foreach ($historiagarantia->result_array as $todasgarantias) { ?>
                                <tr class="prueba">    
                                    ...
                                    <td><input type="checkbox" name="garantias[]" id="garantias" value="<?= $todasgarantias['COD_TIPO_GARANTIA'] ?>"></td>
                                </tr>
                            <?php } ?>
                        ...
                        <div style="text-align:center;"><br><input  type="submit"  class="btn btn-success" name="Eliminar" id="Eliminar" value="Eliminar"></div>
                    </form>
                    <div id="editar">
                        <table>
                            <tr>
                    ...
                    <script>
                        ...
                        $('#estilogarantias tbody tr td').click(function() {
