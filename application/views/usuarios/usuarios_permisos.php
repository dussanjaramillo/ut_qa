...
<h2>Editar permisos para el usuario <span class="text-info">"<?php echo $result->NOMBREUSUARIO ?>"</span> </h2>
...
"bProcessing": true,
"bServerSide": true,
"sAjaxSource": "<?php echo base_url(); ?>index.php/usuarios/elegir/<?php echo $result->IDUSUARIO; ?>",
"sServerMethod": "POST",
"aoColumns": [ 
            { "sClass": "item" }, /*id 0*/
            { "sClass": "item" }, /* 1 */
...
"fnDrawCallback": function( oSettings ) {
             ...
             $("#destino").load("<?php echo base_url(); ?>index.php/usuarios/predeterminar", {id_menu: ID, id_usuario:<?php echo $result->IDUSUARIO; ?>}, function(){
                oTable.fnDraw();  
              });
             ...
             var IDP = $(this).attr("id");
              $("#destino").append('<i class="fa fa-spinner fa-spin"></i>');
              $("#destino").load("<?php echo base_url(); ?>index.php/usuarios/despredeterminar", {id_permiso: IDP}, function(){
                oTable.fnDraw();
              });
...
<div id="destino"></div>
<?php
echo anchor(base_url().'index.php/usuarios','<i class="fa  fa-arrow-left "></i> Regresar','class="btn btn-large"');
?>
<br><br>
