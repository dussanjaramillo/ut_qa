<?php 
/**
* Formulario para la consulta procesos de liquidaciones de crédito que pueden generar notificaciones por escrito
*
* @package    Cartera
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/consultar_expediente_notificacion.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/consultarExpedienteNotificacion', $atributos_formulario);
	?>
	<h2 class="text-center">Consultar Expedientes con Liquidaciones de Crédito</h2>
	<br><br>
	<table>
		<tr>
			<td>
...
<!--
/* End of file consultar_expediente_notificacion.php */
-->