...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open_multipart('liquidaciones_credito/cargarSoporte', $atributos_form);
	?>
	<h2 class="text-center">Validar Notificaciones Escritas de Liquidación de Crédito </h2>
	<br><br>
	<table>
		<tr>
			<td>
		...
		<tr>
			<td>Estado:
				<select>
				  <option value="volvo">Enviado</option>
				  <option value="saab">Comunicación Entregada</option>
				  <option value="mercedes">Comunicación Devuelta</option>
				</select>
			</td>
		</tr>
		<tr>
			<td>Número de Rádico OnBase: <input type="text" name="lname"></td>
		</tr>
		<tr>
			<td>Motivo: 
				<select>
					<option value="volvo">Desconocido</option>
				  <option value="saab">Dirección Errada</option>
				  <option value="mercedes">No Reclamado</option>
				  <option value="mercedes">Rehusado</option>
				  <option value="mercedes">No Reside</option>
				  <option value="mercedes">Apartado Clausurado</option>
				  <option value="mercedes">Cerrado</option>
				  <option value="mercedes">No existe</option>
				  <option value="mercedes">Fallecido</option>
				  <option value="mercedes">No Contactado</option>
				  <option value="mercedes">Fuerza Mayor</option>
				  <option value="mercedes">Destinatario Desconocido</option>
				</select>
			</td>
		</tr>
		<tr>
			<td>Colilla: <input type="text" name="lname"></td>
		</tr>
		<tr>	
			<td>
				<?php 
