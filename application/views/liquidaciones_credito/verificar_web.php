...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open_multipart('liquidaciones_credito/cargarSoporteWeb', $atributos_form);
	?>
	<h2 class="text-center">Validar Notificaciones Web de Liquidación de Crédito </h2>
	<br><br>
	<table>
		<tr>
			<td>
