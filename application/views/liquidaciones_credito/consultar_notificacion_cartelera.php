<?php 
/**
* Formulario para la consulta procesos de liquidaciones de crédito que tienen notificaciones de cartelera
*
* @package    Cartera
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/consultar_notificacion_cartelera.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/VerificarCarteleras', $atributos_formulario);
	?>
	<h2 class="text-center">Consultar Expedientes con Notificación por Cartelera</h2>
	<br><br>
	<table>
		<tr>
			<td>
...
<!--
/* End of file consultar_notificacion_cartelera.php */
-->