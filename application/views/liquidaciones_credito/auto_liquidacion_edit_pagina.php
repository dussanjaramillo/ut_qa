...
$dataEstado     = array('name'=>'id_estado','id'=>'id_estado','type'=>'text','value'=>@$result->COD_ESTADO);
...
?>        
       ...
       <tr>
        ...
        <tr id="geNotifi" style="display:none" align='center'>
            <td colspan='2'>
        ...
        <tr>
            <td id="selectAsigna" style="display:none" align='center'>
                <table>
                    <tr>   
