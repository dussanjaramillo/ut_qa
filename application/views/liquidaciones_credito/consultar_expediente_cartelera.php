<?php 
/**
* Formulario para la consulta procesos de liquidaciones de crédito que pueden generar notificaciones en cartelera
*
* @package    Cartera
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/consultar_expediente_cartelera.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/consultarExpedienteCarteleras', $atributos_formulario);
	?>
	<h2 class="text-center">Consultar Expedientes para Notificación por Cartelera</h2>
	<br><br>
	<table>
		<tr>
			<td>
...
<!--
/* End of file consultar_expediente_cartelera.php */
-->