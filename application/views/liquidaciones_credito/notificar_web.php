...
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/notificar_web.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/grabarNotificacionWeb', $atributos_formulario);
	?>
   ...
   <table>
		<tr>
			<td style = "text-align:center;">
				<a class="btn" href="<?php echo site_url(); ?>/liquidaciones_credito/formularioExpedienteWeb"><i class="icon-remove"></i> Cancelar</a>
			</td>
			<td style = "text-align:center;">
				<?php
