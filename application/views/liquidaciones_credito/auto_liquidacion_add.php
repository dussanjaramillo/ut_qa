...
$dataFisca      =   array('name'=>'cod_coactivo','id'=>'cod_coactivo','type'=>'hidden','value'=>$cod_coactivo);
...
?>
    ...
    <table cellspacing="0" cellspading="0" border="0" align="center">
        <tr>
            <td>
            <?php
            $this->load->view('liquidaciones_credito/cabecera',$this->data); 
            ?>
            </td>
        </tr>
        <tr>
...
$('#guardar').click(function() {
        ...
        var url = '<?php echo base_url('index.php/liquidaciones_credito/guardar_auto')?>';
...
$('#pdf').click(function() {
        ...
        $("#LiquidacionAdd").attr("action", "<?= base_url('index.php/liquidaciones_credito/pdf')?>");
