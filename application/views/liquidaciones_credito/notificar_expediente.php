<?php 
/**
* Formulario para la generación de notificaciones por escrito para liquidaciones de crédito
*
* @package    Cartera
* @subpackage Views
* @author     jdussan
* @location   application/views/liquidaciones_credito/notificar_expediente.php
...
<div class="center-form-large" id="cabecera">
	<?php
		...
		echo form_open('liquidaciones_credito/grabarExpedienteNotificacion', $atributos_formulario);
	?>
	<h2 class="text-center">Generar Notificaciones de Liquidación de Crédito</h2>
	<br><br>
	<table>
		<tr>
   ...
   <table>
		<tr>
			<td style = "text-align:center;">
				<a class="btn" href="<?php echo site_url(); ?>/liquidaciones_credito/formularioExpedienteNotificacion"><i class="icon-remove"></i> Cancelar</a>
			</td>
			<td style = "text-align:center;">
				<?php
...
<!--
/* End of file notificar_expediente.php */
-->