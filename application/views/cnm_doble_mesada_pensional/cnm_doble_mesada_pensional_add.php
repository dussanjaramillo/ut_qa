...
<table width="780" border="0">
   ...
   <td><input type="text" id="tipo_cartera" name="tipo_cartera" style="width : 91%;" readonly="readonly" value="<?=$tipoCartera["NOMBRE_CARTERA"]?>"><input type="hidden" id="cod_tipo_cartera" name="cod_tipo_cartera" value="<?=$tipoCartera["COD_TIPOCARTERA"]?>"></td>
    ...
    <td><input type="text" id="fecha_pension" name="fecha_pension" style="width : 84%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="fecha_activacion" name="fecha_activacion" style="width : 84%;" readonly="readonly" onchange ="presubmit();"></td>
  	<td>&nbsp;</td>
  </tr>
