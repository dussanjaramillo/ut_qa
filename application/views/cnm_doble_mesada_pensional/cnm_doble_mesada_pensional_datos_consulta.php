...
<center><h3>DOBLE MESADA PENSIONAL</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_doble_mesada_pensional/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_doble_mesada_pensional/edit') ?>" method="post" >
