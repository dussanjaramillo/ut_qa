...
<div class="center-form-xlarge">
	...
	<div class="row-fluid" id="cabecera">
		<table>
			<tr>
				<td width = "25%"><strong>Nit: </strong><br><span class="muted"> <?php echo $empresa ['CODEMPRESA']; ?></span></td>
				<td width = "25%"><strong>Empresa: </strong><br><span class="muted"><?php echo $empresa ['RAZON_SOCIAL']; ?></span></td>
				<td width = "25%"><strong>Concepto: </strong><br><span class="muted"><?php echo $empresa ['NOMBRE_CONCEPTO']; ?> </span></td>
				<td width = "25%"><strong>Número de Liquidación: </strong> <br><span class="muted"><?php echo $empresa ['NUM_LIQUIDACION']; ?></span></td>
			</tr>
		</table>
	</div>
	<br><br>
	...
	<div id="formulario">
		<div class="row-fluid">
			...
			<span class="span4">
				<?php
					$atributos_radicado = array ('name' => 'numeroRadicado', 'id' => 'numeroRadicado', 'class'  => 'input-large', 'type' => 'text', 'maxlength' => '15', 'onkeypress' => 'return soloNumeros(event);');
		...
		<div class="row-fluid">
			...
			<span class="span4">
				<?php
					$atributos_nis = array ('name' => 'nis', 'id' => 'nis', 'class'  => 'input-large', 'type' => 'text', 'maxlength' => '50');
	...
	<br><br>
        <center>
		<?php
			echo '<table width = "100%"><tr><td width = "50%" class = "text-center">';
			echo anchor('liquidaciones/legalizarLiquidacion', '<i class="fa fa-minus-circle"></i> Cancelar', 'class="btn btn-warning"');
			echo '</td><td width = "50%" class = "text-center">';
			$atributos_boton = array('id' =>'submit-button', 'name' => 'aceptar', 'class' => 'btn btn-success', 'content' => '<i class="icon-file icon-white"></i> Liquidación en Firme', 'type' => 'submit');
