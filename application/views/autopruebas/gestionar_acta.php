...
echo form_open_multipart("autopruebas/correspondencia_citacion2222", $attributes);
?>
...
<input type="hidden" readonly="readonly" name="fecha_formulario" id="fecha_formulario" value="<?php echo date("d/m/Y"); ?>">
<input type="hidden" readonly="readonly" name="fecha_resolucion" id="fecha_resolucion" value="<?php echo $consulta[0]['FECHA_CREACION']; ?>">
<input type="hidden" readonly="readonly" name="resolucion" id="resolucion" value="<?php echo $consulta[0]['NUMERO_RESOLUCION']; ?>">
<input type="hidden" name="telefono" readonly="readonly" id="telefono" value="<?php echo $consulta[0]['TELEFONO_FIJO']; ?>">
<input type="hidden" readonly="readonly" name="direccion_empresa" id="direccion_empresa" value="<?php echo $consulta[0]['DIRECCION']; ?>">
<input type="hidden" name="telefono_notofocador" readonly="readonly" id="telefono_notofocador" value="<?php echo $user->TELEFONO; ?>">
<input type="hidden" id="direccion_notofocador" readonly="readonly" name="direccion_notofocador" value="<?php echo $consulta[0]['DIRECCION_REGIONAL']; ?>">
...
<tr>
    ...
    <table width='60%'>
        <tr>
            ...
            <td><input type="radio" name="notificacion" value="38" onclick="editor(1)" checked="true"></td>
        </tr>
<!--        <tr>
...
//        $('#textarea2').show();
    ...
    $('#enviar3').click(function() {
        ...
        $(".preload, .load").show();
        var url = "<?php echo base_url('index.php/autopruebas/correspondencia_citacion_gestion') ?>";
