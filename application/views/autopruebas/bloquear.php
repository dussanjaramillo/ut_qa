...
<script>
    ...
    $('#desbloquear').click(function(){
        ...
        var url = "<?php echo base_url("index.php/autopruebas/desbloquear"); ?>";
        $.post(url,{id: id,nit:nit,cod_fis:cod_fis,gestion:gestion,fecha:fecha,num_citacion:num_citacion})
                .done(function(msg){
