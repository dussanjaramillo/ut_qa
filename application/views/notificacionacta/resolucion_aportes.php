...
<table><tr><td></td><td colspan=''></td></tr></table>
<?php
//echo "<pre>";
//print_r($detalle);
//echo "</pre>";
...
for ($i = 0; $i < $cantidad; $i++) {
    ...
    $table .="</table><p>";
    $table.= "</td>";
    $dia_visita = $detalles['DIA_V'];
    $mes_visita = $detalles['MES_V'];
    $ano_visita = $detalles['ANO_V'];
    $fiscalizador = $detalles['FISCALIZADOR'];
    $periodo_inicial = $detalles['PERIODO_INICIAL'];
    $periodo_final = $detalles['PERIODO_FINAL'];
}
$table.= "</tr>";
$table .="</table><p>";

$array = array();
$array['dia_visita'] = $dia_visita;
$array['mes_visita'] = $mes_visita;
$array['ano_visita'] = $ano_visita;
$array['fiscalizador'] = $fiscalizador;
$array['periodo_inicio'] = $periodo_inicial;
$array['periodo_final'] = $periodo_final;
...
$html = Notificacionacta::plantillas(109, $array);
