...
$linea2 = "POR LA CUAL SE FIJA LA CUOTA DE APRENDICES
EL DIRECTOR DE LA REGIONAL ANTIOQUIA
...
$linea14 = ""; // "Elaborado por: " . $informacion['elavora'];
$html = '
...
' . $linea9 . '<br>' . $linea10 . '<br>' . $linea11 . '<br>' . $linea12 . '<br>' . $linea13 . '<br>' . $linea14 . '
    </div>
    ';
if (!empty($pdf)) {
