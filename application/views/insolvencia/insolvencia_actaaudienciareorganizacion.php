...
$valobl_actreo  = array('name'=>'valobl_actreo','class'=>'search-query','id'=>'valobl_actreo','disabled'=>'true','type'=>'number');
...
<?php echo form_open_multipart("insolvencia/guardar_acta_reorganizaion", $atributos); 
        echo form_input($fiscalizacion);
        ?>
           <table>
                <tr>
                    <td colspan="4">
                        <div align="center"><h3>Acta de acuerdo de reorganizaci&oacute;n</h3></div>
                    </td>
                </tr>
                <tr>
...
<!--                    <div id="ela_pdf" style="max-width: 870px;min-width: 320px;padding: 40px;width: 108%;background: none repeat scroll 0 0 #F0F0F0;margin: auto;">            
                        <div align="center" style="color: #ffffff;"><h3>Cargar acta de acuerdo de reorganizaci&oacute;n</h3></div>   
                    <br>//<?= form_input($logo)?>
