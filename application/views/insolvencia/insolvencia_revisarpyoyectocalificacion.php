...
<div style="max-width: 1015px;min-width: 320px;padding: 40px;width: 88%;background: none repeat scroll 0 0 #F0F0F0;margin: auto;">
    <div align="center"><h3>Revisar Proyectos de Calificación y Graduación de Créditos, Derechos de Voto e Inventario de Bienes </h3></div>
...
<div id="mensaje" style="display: none;">Debe de Hacer la Búsqueda por un Solo Parámetro</div>
    ...
    oTable = $('#titulos').dataTable( {
        ...
        "fnServerParams": function ( aoData ) {
            aoData.push( { "name": "viene", "value": '4' } );
        },
        "autoWidth": true,
        ...
        "aoColumns": [
               ...
               { "mData": null,"sClass": "center",
                    ...
                    "fnRender": function (oObj) {
                        ...
                        gestion1 = "<a class='btn' id=\"" + oObj.aData.COD_TITULO + "\" onclick='enviar(this.id)'><i class=\"fa fa-pencil-square-o\" ></i></a>";
                        return gestion1;
                      }
                  }                            
           ]
   ...
   // alert("prueba"+h+" prueba 1"+p);
    ...
    var url       = "<?=base_url()?>index.php/insolvencia/revisar_proyeto";
