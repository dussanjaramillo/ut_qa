...
<div style="max-width: 1015px;min-width: 320px;padding: 40px;width: 88%;background: none repeat scroll 0 0 #F0F0F0;margin: auto;">
    <div align="center"><h3>Asistir a la Audiencia Donde se Resuelven Objeciones </h3></div>
...
<div id="mensaje" style="display: none;">Debe de Hacer la Búsqueda por un Solo Parámetro</div>
    ...
    oTable = $('#titulos').dataTable( {
        ...
        "fnServerParams": function ( aoData ) {
            aoData.push( { "name": "viene", "value": '6' } );
        },
        "autoWidth": true,
        ...
        "aoColumns": [
               ...
               { "mData": null,"sClass": "center",
                    ...
                    "fnRender": function (oObj) {
                        ...
                        gestion1 = "<a class='btn' id=\"" + oObj.aData.COD_RECEPCIONTITULO + "\" onclick='enviar(this.id)'><i class=\"fa fa-pencil-square-o\" ></i></a>";
                        return gestion1;
                      }
                  }                            
           ]
   ...
   // alert("prueba"+h+" prueba 1"+p);
    ...
    var url       = "<?=base_url()?>index.php/insolvencia/elaborar_audiencia";  
