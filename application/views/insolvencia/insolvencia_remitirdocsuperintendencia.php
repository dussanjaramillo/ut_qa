...
$button             = array('name'=>'salir','id'=>'salir','value'=>'salir','content'=>'<i class=""></i> Salir','class'=>'btn btn-warning btn1');
?>
<div style="max-width: 1015px;min-width: 320px;padding: 40px;width: 88%;background: none repeat scroll 0 0 #F0F0F0;margin: auto;">
    <div align="center"><h3>Remitir Documentos de Crédito a la Superintendencia</h3></div>
...
<div id="mensaje" style="display: none;">Debe de Hacer la Búsqueda por un Solo Parámetro</div>
   ...
   // alert("prueba"+h+" prueba 1"+p);
    ...
    var url       = "<?=base_url()?>index.php/insolvencia/remitir_dcumento";  
