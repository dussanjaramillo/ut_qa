...
<?php if($data['COD_ESTADO']==1||$data['COD_ESTADO']==3){ ?>
	<center><a class="btn btn-small ateditar" title="Editar" ateditar="<?=$data['COD_CARTERA_NOMISIONAL']?>" ateditartipo="<?=$data['COD_TIPOCARTERA']?>"><i class="icon-edit"></i></a></center>	
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_otras_carteras/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_otras_carteras/edit') ?>" method="post" >
    <input type="hidden" id="id_cartera_edit" name="id_cartera_edit">
    <input type="hidden" id="cod_tipo_cartera_ed" name="cod_tipo_cartera_ed">
</form>
...
<script type="text/javascript" language="javascript" charset="utf-8">
	...
	$('.atgestion').click(function() {
		...
		$('#cod_tipo_cartera_ed').val($(this).attr('ateditartipo'));
