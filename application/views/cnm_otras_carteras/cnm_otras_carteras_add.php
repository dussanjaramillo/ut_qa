...
<table width="780" border="0">
 ...
 <tr>
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
    <td><input type="text" id="plazo" name="plazo" style="width : 15%;" onchange ="presubmit();" required="required">
    	...
    	<?php
          ...
          echo form_dropdown('plazo_id', $selectplazo,'','id="plazo_id" onchange ="presubmit();" style="width : 75%;" class="chosen" data-placeholder="seleccione..." ');
