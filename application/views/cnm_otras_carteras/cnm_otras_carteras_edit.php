...
<table width="780" border="0">
 ...
 <tr>
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
    <td><input type="text" id="plazo" name="plazo" style="width : 15%;" onchange ="presubmit();" required="required" value="<?=$detalleCart["PLAZO_CUOTAS"]?>">
...
<tr>
    ...
    {?>
    	...
    	<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,$detalleCart["CALCULO_CORRIENTE"],'onchange ="presubmit();" id="combo_tipo_tasa_corriente" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
