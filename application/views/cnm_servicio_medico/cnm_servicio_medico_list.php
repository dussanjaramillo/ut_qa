...
<center>
<h2>Detalle Cartera Servicio Médico</h2>
...
<table width="780" border="0">
 ...
 <td><input type="text" id="tipo_acuerdo" style="width : 91%;" readonly="readonly" ></td>
    <td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
    <td><b>Titulo o Libranza:</td>
    <td><input type="text" id="letra" name="letra" style="width : 91%;" readonly="readonly" value="<?=$carteras["LETRA"]?>"></td>
    <td>&nbsp;</td>
    <td><b>Vigencia:</td>
    <td><input type="text" id="vigencia" name="vigencia" style="width : 91%;" readonly="readonly" value="<?=$carteras["VIGENCIA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
  
        <tr>
    <td>&nbsp;</td>	
    <td><b>Id. Beneficiario:</td>
    <td><input type="text" id="id_beneficiario" name="id_beneficiario" style="width : 91%;" readonly="readonly" value="<?=$carteras["COD_BENEFICIARIO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
          ...
          <tr>
    <td>&nbsp;</td>	
   	<td><b>Nombre Beneficiario:</td>
    <td><input type="text" id="n_beneficiario" name="n_beneficiario" style="width : 91%;" readonly="readonly" value="<?=$carteras["NOMBRES_BENEFICIARIO"]?>"></td>
  	<td>&nbsp;</td>
    <td><b>Apellido Beneficiario:</td>
    <td><input type="text" id="a_beneficiario" name="a_beneficiario" style="width : 91%;" readonly="readonly" value="<?=$carteras["APELLIDOS_BENEFICIARIO"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
  
        <tr>
    <td>&nbsp;</td>	
    <td><b>Id. Contratista:</td>
    <td><input type="text" id="id_contratista" name="id_contratista" style="width : 91%;" value="<?=$carteras["COD_CONTRATISTA"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Nombre Contratista:</td>
    <td><input type="text" id="n_contratista" name="n_contratista" style="width : 91%;" readonly="readonly" value="<?=$carteras["NOMBRE_CONTRATISTA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>	
    <td><b>Identificación Deuda:</td>
    <td><input type="text" id="id_deuda" name="id_deuda" style="width : 91%;" readonly="readonly" disabled="disabled" value="<?=$carteras["COD_CARTERA_NOMISIONAL"]?>"></td>
    <td>&nbsp;</td>
    <td><b>Fecha de Orden:</td>
    <td><input type="text" id="fecha_orden" name="fecha_orden" style="width : 91%;" readonly="readonly" value="<?=$carteras["FECHA_ORDEN"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
    <td><b>Número de Orden:</td>
    <td><input type="text" id="numero_orden" name="numero_orden" style="width : 91%;" value="<?=$carteras["ORDEN"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td><b>Valor Orden:</td>
    <td><input type="text" id="valor_orden" name="valor_orden" style="width : 91%;" value="<?=number_format($carteras["VALOR_ORDEN"], 0, ',', '.')?>" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
        <tr>
    <td>&nbsp;</td>	
    <td><b>Valor Excedido:</td>
    <td><input type="text" id="valor_excedido" name="valor_excedido" style="width : 91%;" value="<?=number_format($carteras["VALOR_EXCEDIDO"], 0, ',', '.')?>" readonly="readonly"></td>
    <td>&nbsp;</td>
	<td><b>Valor Reintegro:</td>
    <td><input type="text" id="valor_reintegro" name="valor_reintegro" style="width : 91%;" value="<?=number_format($carteras["VALOR_REINTEGRAR"], 0, ',', '.')?>" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    <tr>
    <td>&nbsp;</td>	
    <td><b>Recibo Pago:</td>
    <td><input type="text" id="recibo_pago" name="recibo_pago" style="width : 91%;" readonly="readonly" value="<?=$carteras["RECIBO_PAGO"]?>"></td>
    <td>&nbsp;</td>
    <td><b>Fecha Pago:</td>
    <td><input type="text" id="fecha_pago" name="fecha_pago" style="width : 91%;" readonly="readonly" value="<?=$carteras["FECHA_PAGO"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
  
        <tr>
    <td>&nbsp;</td>	
    <td><b>Fecha de Titulo:</td>
    <td><input type="text" id="fecha_resolucion" name="fecha_resolucion" style="width : 84%;" readonly="readonly" value="<?=$carteras["FECHA_RESOLUCION"]?>"></td>
    <td>&nbsp;</td>
    <td><b>Número Titulo:</td>
