...
<center>
<h2>Registro Cartera Servicio Médico</h2>
...
<table width="780" class="tabla2">
  ...
  <tr>
    ...
    <td><input type="text" id="cedula" name="cedula" value="<?=$datos_c["COD_DEUDOR"]?>" readonly="readonly" style="width : 91%;" required="required"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<td><input type="text" id="tipo_acuerdo_id" name="tipo_acuerdo_id" style="width : 91%;" readonly="readonly" disabled="disabled"></td>
 ...
 ?> 
    ...
    <td>&nbsp;</td>	
    <td>Letra</td>
    <td><input type="text" id="letra" name="letra" style="width : 91%;" value="<?=$datos_c["LETRA"]?>"></td>
    <td>&nbsp;</td>
    <td>Vigencia</td>
    <td><input type="text" id="vigencia" name="vigencia" style="width : 84%;" readonly="readonly" value="<?=$datos_c["VIGENCIA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="id_beneficiario" name="id_beneficiario" style="width : 91%;" value="<?=$datos_c["IDENTIFICACION_BENEFICIARIO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td><input type="text" id="n_beneficiario" name="n_beneficiario" style="width : 91%;" readonly="readonly" value="<?=$datos_c["NOMBRE_BENEFICIARIO"]?>"></td>
  	<td>&nbsp;</td>
    <td>Apellido Beneficiario</td>
    <td><input type="text" id="a_beneficiario" name="a_beneficiario" style="width : 91%;" readonly="readonly" value="<?=$datos_c["APELLIDOS_BENEFICIARIO"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="id_contratista" name="id_contratista" style="width : 91%;" value="<?=$datos_c["CONTRATISTA"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Nombre Contratista</td>
    <td><input type="text" id="n_contratista" name="n_contratista" style="width : 91%;" readonly="readonly" value="<?=$datos_c["NOMBRE_CONTRATISTA"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>	
    ...
    <td><input type="text" id="fecha_orden" name="fecha_orden" style="width : 84%;" readonly="readonly" value="<?=$datos_c["FECHA_ORDEN"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
    <td>Número de Orden</td>
    <td><input type="text" id="numero_orden" name="numero_orden" style="width : 91%;" value="<?=$datos_c["ORDEN"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Valor Orden</td>
    <td><input type="text" id="valor_orden" name="valor_orden" style="width : 91%;" value="<?=$datos_c["VALOR_ORDEN"]?>" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
        <tr>
    <td>&nbsp;</td>	
    <td>Valor Excedido</td>
    <td><input type="text" id="valor_excedido" name="valor_excedido" style="width : 91%;" value="<?=$datos_c["VALOR_EXCEDIDO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
	<td>Valor Reintegro</td>
    <td><input type="text" id="valor_reintegro" name="valor_reintegro" style="width : 91%;" value="<?=$datos_c["VALOR_REINTEGRAR"]?>" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    <tr>
    <td>&nbsp;</td>	
    <td>Recibo Pago</td>
    <td><input type="text" id="recibo_pago" name="recibo_pago" style="width : 91%;" value="<?=$datos_c["RECIBO_PAGO"]?>"></td>
    <td>&nbsp;</td>
    <td>Fecha Pago</td>
    <td><input type="text" id="fecha_pago" name="fecha_pago" style="width : 84%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
