...
<center><h3>EXCEDENTES DE SERVICIO MÉDICO</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_servicio_medico/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>

<form id="edicion_cartera" action="<?= base_url('index.php/cnm_servicio_medico/creacion') ?>" method="post" >
