...
<center><h3>RESPONSABILIDAD ADMINISTRATIVA DE FONDOS</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_responsabilidad_fondos/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_responsabilidad_fondos/edit') ?>" method="post" >
