...
"sAjaxSource": "<?php echo base_url(); ?>index.php/admestructuras/datatablecamposarchivos/<?php echo $this->uri->segment(3); ?>",
"sServerMethod": "POST",
"aoColumns": [ 
                      { "sClass": "center" }, /*id 0*/
                      { "sClass": "item" },
...
<p>
    <div align="center">
                ...
                <?php 
                echo anchor(base_url().'index.php/admestructuras/addcampoarch/'.$this->uri->segment(3).'','<i class="icon-star"></i> Agregar Campo','class="btn btn-success"');
                ?>
