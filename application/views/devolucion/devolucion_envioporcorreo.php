<?php
$hoy                = date("d/m/Y");
$numrad_envioconta  = array('name'=>'numrad_enviocorreo','class'=>'search-query','id'=>'numrad_enviocorreo','value'=>$numero);
...
$button             = array('name'=> 'aceptar_correo','id'=>'aceptar_correo','type'=>'submit','value'=>'Aceptar','content'=>'<i class=""></i> Aceptar','class'=>'btn btn-success btn1');
?>
<div style="max-width: 686px;min-width: 320px;padding: 40px;width: 88%;background: none repeat scroll 0 0 #F0F0F0;margin: auto;">
   <?= form_open('devolucion/guardar_envio_porcorreo')?>
    <table>
        <tr>
