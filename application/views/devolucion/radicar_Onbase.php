...
$dataidenti = array('name' => 'identificacion', 'id' => 'identificacion', 'type' => 'number', 'required' => 'true');
...
<div class="caja_negra" id="caja_negra" style="width: 60%; background: #F8F8F8; border-color: black; border: 1px solid grey; margin: auto; overflow: hidden;alignment-adjust: central ;padding: 15px 50px 0">
    <br> <table align='center'>
        ...
        <tr>
        <p>
        <td colspan='2'><?= '<b>Comentarios&nbsp;</b><span class="required"><font color="red"><b>*</b></font></span>' . form_textarea($data); ?></td>                    
        </p>            
    </tr><tr><td><br></td></tr> 
<tr>
...
<script type="text/javascript">
    ...
    $('#guardar').click(function() {
        ...
        var url = '<?php echo base_url('index.php/devolucion/guardar_Onbase') ?>';
        var valida = true;
        ...
        if (onbase == '') {
            ...
            $('#error').show();
            $('#num_radicado').focus();
            $('#error').html("<font color='red'><b>Por Favor Ingrese la Fecha de Radicado</b></font>");
            valida = false;
        }else if (conceptos == '') {
            $('#error').show();
            $('#conceptos').focus();
