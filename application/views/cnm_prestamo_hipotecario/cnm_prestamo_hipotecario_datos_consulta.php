...
<center><h3>PRESTAMO HIPOTECARIO</h3></center>
</br>
...
<?php } elseif($data['COD_ESTADO']==4||$data['COD_ESTADO']==5||$data['COD_ESTADO']==7){ ?>	
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_prestamo_hipotecario/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_prestamo_hipotecario/edit') ?>" method="post" >
