...
<td>    	 
 ...
 ?> 
  ...
  <tr>
    ...
    <td><input type="text" id="fecha_solicitud" name="fecha_solicitud" style="width : 84%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
    <td>Fecha de Escritura</td>
    <td><input type="text" id="fecha_escritura" name="fecha_escritura" style="width : 84%;" readonly="readonly"></td>
  	    <td>&nbsp;</td>
    <td>Número de Escritura</td>
    <td><input type="text" id="numero_escritura" name="numero_escritura" style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><?php
          ...
          echo form_dropdown('tipo_estado_id', $selecttipoestado,'','id="tipo_estado_id" style="width : 97%;" class="chosen" data-placeholder="seleccione..." ');
    ...
    <td>&nbsp;</td>	
    <td>Valor Deuda</td>
    <td><input type="text" id="valor_deuda" name="valor_deuda" style="width : 91%;" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);" onchange ="presubmit();"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
    <td><input type="text" id="plazo" name="plazo" style="width : 15%;" required="required" onchange ="presubmit();">
    	...
    	<?php
          ...
          echo form_dropdown('plazo_id', $selectplazo,'','id="plazo_id" style="width : 75%;" class="chosen" onchange ="presubmit();" data-placeholder="seleccione..." ');
...
<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,'','id="combo_tipo_tasa_corriente" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" style="width : 15%;" required="required" onchange ="presubmit();">%
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,'','id="aplica_tasa_c" style="width : 30%;" class="chosen" data-placeholder="seleccione..." ');
    ...
    <td>Tasa de Seguro</td>
      <td><?php
        ...
        ?>
        <input type="hidden" id="combo_tipo_tasa_seg_hid" style="width : 15%;">
    	
    	<input type="text" id="valor_tasa_seg" name="valor_tasa_seg" style="width : 15%;" readonly="readonly">%
    	<?php
          ...
          echo form_dropdown('tasa_esp_seg', $selecttasamora,'','id="tasa_esp_seg" readonly="readonly" disabled="disabled" style="width : 30%;" class="chosen" data-placeholder="seleccione..." ');
         
           echo form_error('tasa_esp_seg','<div>','</div>');
        

        ?>
<input type="hidden" id="aplica_tasa_m_hid" style="width : 15%;"></td>
    ...
    <td>
        ...
        ?>
   <input type="text" id="fecha_incremento" name="fecha_incremento" style="width : 50%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="id_garantia" name="id_garantia" style="width : 91%;"></td>
    <td>&nbsp;</td>
    <td>Descripcion Garantía</td>
    <td><input type="text" id="desc_garantia" name="desc_garantia" style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="n_poliza" name="n_poliza" style="width : 91%;"></td>
    <td>&nbsp;</td>
    <td>Aseguradora</td>
    <td><input type="text" id="aseguradora" name="aseguradora" style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td>&nbsp;</td>	
    <td>Salario</td>
    <td><input type="text" id="salario" name="salario" onchange ="presubmit();" style="width : 91%;" maxlength="10" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>Factor Tipo</td>
    <td><input type="text" id="factor_tipo" name="factor_tipo" onchange ="presubmit();" style="width : 91%;" required="required"></td>
    <td>&nbsp;</td>
  </tr> 
           <tr>
    <td>&nbsp;</td>	
    <td>Tasa IPC</td>
    <td><input type="text" id="tasa_ipc" name="tasa_ipc" style="width : 91%;" onchange ="presubmit();" maxlength="6" required="required"></td>
    <td>&nbsp;</td>
    <td>Tasa Interés Cesantias</td>
    <td><input type="text" id="tasa_cesantia" name="tasa_cesantia" style="width : 91%;" onchange ="presubmit();" maxlength="6" required="required"></td>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="valor_cuota_aprob" name="valor_cuota_aprob" maxlength="10" style="width : 91%;" onchange ="presubmit();" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>Gradiente</td>
    <td><input type="text" id="gradiente" name="gradiente" style="width : 91%;" maxlength="6" required="required" onchange ="presubmit();"></td>
    <td>&nbsp;</td>
  </tr>
             <tr>
    <td>&nbsp;</td>	
    <td>Fecha Retiro</td>
    <td><input type="text" id="fecha_retiro" name="fecha_retiro" style="width : 84%;" required="required" readonly="readonly" onchange ="presubmit();"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td><input type="text" id="id_codeudor" name="id_codeudor" style="width : 91%;"></td>
    <td>&nbsp;</td>
    <td>Nombre Codeudor&nbsp&nbsp&nbsp&nbsp&nbsp</td>
    <td><input type="text" id="nombre_codeudor" name="nombre_codeudor" style="width : 91%;"></td>
    <td>&nbsp;</td>
  </tr> 
  <tr><td>&nbsp;</td>	</tr> 
   <tr>
