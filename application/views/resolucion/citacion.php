...
<div id="primario">
    <input type="hidden" id="cod_coordinador" name="cod_coordinador" value="<?php echo $consulta[0]['CEDULA_COORDINADOR_RELACIONES'] ?>">
    ...
    <table width="800px">
        <tr>
            ...
            <td><input type="text" id="resolucion" name="resolucion" readonly="readonly" value="<?php echo $consulta[0]['NUMERO_RESOLUCION'] ?>"></td>
        </tr>
        <tr>
            <td>Fecha Resoluci&oacute;n</td>
            <td><input type="text" id="fecha_resolucion" name="fecha_resolucion" readonly="readonly" value="<?php echo $consulta[0]['FECHA_CREACION'] ?>"></td>
            <td>NIT</td>
            <td><input type="text" id="nit" name="nit" readonly="readonly" value="<?php echo $consulta[0]['NITEMPRESA'] ?>"></td>
        </tr>
        <tr>
            <td>FAX</td>
            <td><input type="text" id="fax" name="fax" value="<?php echo $consulta[0]['FAX'] ?>" onkeypress="soloNumero(this);"></td>
        </tr>
        <tr>
            <td>Regional</td>
            ...
            <td colspan="2"><input type="text" id="direccion_regional" readonly="readonly" name="direccion_regional" value="<?php echo $consulta[0]['DIRECCION_REGIONAL'] ?>"></td>
        </tr>
        <tr>
            <td>Ciudad</td>
        ...
        <?php if ($consulta[0]['AUTORIZA_NOTIFIC_EMAIL'] == "s" || $consulta[0]['AUTORIZA_NOTIFIC_EMAIL'] == "S" && 1 == 2) { ?>
            <tr>
                <td>Correo</td>
                <td><input class="validate[custom[email]]" type="text" id="correo" name="correo" value="<?php echo $consulta[0]['CORREOELECTRONICO'] ?>"></td>
                <td>Autoriza Envio</td>
                <td><input type="checkbox" id="autoriza" name="autoriza" ></td>
            </tr>
            <tr>
                <td colspan="6"><hr></td>
            </tr>
        <?php } else { ?>
            <tr>
                <td style="color:red">
                    <!--El cliente no acepta que le envien correos-->
                </td>
            </tr>
            <tr>
                <td colspan="6">
...
<div id="secundario" style="display: none">
        ...
        <table  border="0" style="border: 0px solid #000">
            <?php if ($consulta[0]['COD_ESTADO'] == "29" || $consulta[0]['COD_ESTADO'] == "662") { ?>
                <tr>
    ...
    <div id="textarea" style="display: none">
        <table width="100%">
            ...
            <tr>
                <td align="center">
                    <button id="enviar2" class="btn btn-success"><i class="fa fa-floppy-o"></i> Notificaci&oacute;n</button>
                </td>
            </tr>
        </table>
    </div>
...
//        alert(confir);
    ...
    $('#enviar2').click(function() {
        ...
        $.post(url, {informacion: informacion, id: id, nombre: nombre_archivo, num_resolucion: num_resolucion, cod_fis: cod_fis, nit: nit})
                .done(function(msg) {
                    var url = "<?php echo base_url('index.php/resolucion/guardar_citacion') ?>";
