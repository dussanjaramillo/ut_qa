...
echo form_open_multipart("resolucion/correspondencia_citacion", $attributes);
?>
...
<div id="form3" style="display: none">
    <table width="100%">
        <tr>
            ...
            <td width="50%"><input type="text" name="fecha_actual" class="fecha" readonly="readonly" value="<?php echo date("d/m/Y"); ?>"></td>
        </tr>
        <tr>
...
<div id="boton" style="display: none">
    <table width="100%">
        <tr>
            <td width="50%">N&uacute;mero de Gu&iacute;a</td>
