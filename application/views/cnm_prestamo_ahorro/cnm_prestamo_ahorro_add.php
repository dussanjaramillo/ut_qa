...
<td>    	 
 ...
 ?> 
   ...
   <td><input type="text" id="fecha_resolucion" name="fecha_resolucion" style="width : 84%;" readonly="readonly"></td>
    ...
    <td><input type="text" id="fecha_activacion" name="fecha_activacion" onchange ="presubmit();" style="width : 84%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td>&nbsp;</td>	
    <td>Valor Deuda</td>
    <td><input type="text" id="valor_deuda" name="valor_deuda" onchange ="presubmit();" style="width : 91%;" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td><input type="text" id="plazo" name="plazo" style="width : 15%;" required="required" onchange ="presubmit();">
    	...
    	<?php
          ...
          echo form_dropdown('plazo_id', $selectplazo,'','id="plazo_id" style="width : 75%;" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
...
<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,'','onchange ="presubmit();"id="combo_tipo_tasa_corriente" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" style="width : 15%;" onchange ="presubmit();" required="required">%
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,'','id="aplica_tasa_c" style="width : 30%;" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
    ...
    <td><input type="text" id="id_garantia" name="id_garantia" style="width : 91%;" maxlength="15" onkeypress ="escape3(this);" onblur = "escape3(this);" onkeyup = "escape3(this);"></td>
    <td>&nbsp;</td>
    <td>Descripcion Garantía</td>
    <td><input type="text" id="desc_garantia" name="desc_garantia" style="width : 91%;" onkeypress ="escape2(this);" onblur = "escape2(this);" onkeyup = "escape2(this);" maxlength="35"></td>
  	<td>&nbsp;</td>
  </tr>
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td><input type="text" id="nombre_codeudor" name="nombre_codeudor" style="width : 91%;" onkeypress ="escape(this);" onblur = "escape(this);" onkeyup = "escape(this);" maxlength="35"></td>
    <td>&nbsp;</td>
  </tr> 
  <tr><td>&nbsp;</td>	</tr> 
   <tr>
...
var cedula_comp = $("#cedula").val();
	...
	$.getJSON("<?= base_url('index.php/cnm_prestamo_ahorro/get_datos') ?>/"+$("#cedula").val(),function(data){
