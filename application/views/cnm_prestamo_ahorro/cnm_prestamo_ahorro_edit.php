...
<td>    	 
 ...
 ?> 
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
    <td><input type="text" onchange ="presubmit();" id="plazo" name="plazo" style="width : 15%;" required="required" value="<?=$detalleCart["PLAZO_CUOTAS"]?>">
...
<tr>
    ...
    {?>
    	...
    	<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,$detalleCart["CALCULO_CORRIENTE"],'id="combo_tipo_tasa_corriente" style="width : 34%;" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
    ...
    {?>
    	...
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,$detalleCart["TIPO_T_F_CORRIENTE"],'id="aplica_tasa_c" onchange ="presubmit();" style="width : 30%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="porcent_tasa_c" onchange ="presubmit();" name="porcent_tasa_c" style="width : 15%;">%
    	<?php
  ...
  <?php }  else{?>
  	...
  	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" onchange ="presubmit();" style="width : 15%;" readonly="readonly" disabled="disabled">%
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,'','id="aplica_tasa_c" onchange ="presubmit();" style="width : 30%;" readonly="readonly" disabled="disabled" class="chosen" data-placeholder="seleccione..." ');
  ...
  <?php }  else{?>
    ...
    <input type="text" id="namv_mora" style="width : 10%;" readonly="readonly" disabled="disabled">%N.A.M.V.<input type="text" id="ndv_mora" style="width : 10%;" readonly="readonly" disabled="disabled">%N.D.V.	
 	 ...
 	 <tr>
        ...
        <tr>
    <td>&nbsp;</td>	
    <td>Identificación Garantia</td>
    <td><input type="text" id="id_garantia" name="id_garantia" style="width : 91%;" value="<?=$detalleCart["ID_GARANTIA"]?>" onkeypress ="escape3(this);" onblur = "escape3(this);" onkeyup = "escape3(this);" maxlength="35"></td>
    <td>&nbsp;</td>
    <td>Descripción Garantía</td>
    <td><input type="text" id="desc_garantia" name="desc_garantia" style="width : 91%;" value="<?=$detalleCart["DESC_GARANTIA"]?>" onkeypress ="escape2(this);" onblur = "escape2(this);" onkeyup = "escape2(this);" maxlength="35"></td>
  	<td>&nbsp;</td>
  </tr>
