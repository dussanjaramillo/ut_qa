...
<td><input type="text" id="fecha_acta_compromiso" name="fecha_acta_compromiso" style="width : 84%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Número Acta Compromiso</td>
    <td><input type="text" id="numero_acta_comp"  name="numero_acta_comp"style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
...
<?php
    	...
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,'','id="aplica_tasa_c" style="width : 30%;" readonly="readonly" disabled="disabled" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
