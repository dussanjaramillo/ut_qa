...
<center>
<h2>Registro Cartera Educativo Sanción</h2>
...
<table width="780" class="tabla2">
  ...
  <tr>
    ...
    <td><input type="text" id="cedula" name="cedula" style="width : 91%;" required="required" value="<?=$detalleCart["COD_EMPLEADO"]?>" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<td><input type="text" id="tipo_cartera" name="tipo_cartera" style="width : 91%;" readonly="readonly" value="<?=$tipoCartera["NOMBRE_CARTERA"]?>"><input type="hidden" id="cod_tipo_cartera" name="cod_tipo_cartera" value="<?=$tipoCartera["COD_TIPOCARTERA"]?>"></td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <tr>
    <td>&nbsp;</td>	
    <td>Fecha Acta de Compromiso</td>
<td><input type="text" id="fecha_acta_compromiso" name="fecha_acta_compromiso" style="width : 84%;" readonly="readonly" value="<?=$detalleCart["FECHA_ACTA"]?>"></td>
    <td>&nbsp;</td>
    <td>Número Acta Compromiso</td>
    <td><input type="text" id="numero_acta_comp"  name="numero_acta_comp"style="width : 91%;" value="<?=$detalleCart["NUM_ACTA_COMP"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><?php
          ...
          echo form_dropdown('tipo_estado_id', $selecttipoestado,$detalleCart["COD_ESTADO"],'id="tipo_estado_id" readonly="readonly" disabled="disabled" style="width : 97%;" class="chosen" data-placeholder="seleccione..." ');
...
<td><input type="text" id="fecha_activacion" name="fecha_activacion" style="width : 84%;" readonly="readonly" value="<?=$detalleCart["FECHA_ACTIVACION"]?>"></td>
    ...
    <td>&nbsp;</td>	
    <td>Valor Deuda</td>
    <td><input type="text" id="valor_deuda" name="valor_deuda" style="width : 91%;" required="required" onchange ="presubmit();" value="<?=number_format($detalleCart["VALOR_DEUDA"], 0, ',', '.')?>" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  	<td>&nbsp;</td>
    ...
    <td>&nbsp;</td>	
    <td>Plazo</td>
     <td><input type="text" id="plazo" name="plazo" style="width : 15%;" required="required" onchange ="presubmit();" value="<?=$detalleCart["PLAZO_CUOTAS"]?>">
    ...
    {?>
    	...
    	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" style="width : 15%;" onchange ="presubmit();">%
    	<?php
  ...
  <?php }  else{?>
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,'','id="combo_tipo_tasa_corriente" style="width : 34%;" onchange ="presubmit();" readonly="readonly" disabled="disabled" class="chosen" data-placeholder="seleccione..." ');
         
           echo form_error('combo_tipo_tasa_corriente','<div>','</div>');
        

        ?>   
  	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" style="width : 15%;" readonly="readonly" disabled="disabled" onchange ="presubmit();">%
    	<?php
...
$( "#fecha_acta_compromiso").datepicker({
	
	showOn: 'button',
	buttonText: 'Fecha Acta Compromiso',
	buttonImage: '<?php echo base_url() . "img/calendario.png" ?>',
	buttonImageOnly: true,
	numberOfMonths: 1,
	changeMonth: true,
...
$( "#fecha_activacion").datepicker({
	...
	dateFormat: 'dd/mm/yy',
           ...
           $( "#cedula" ).autocomplete({
      source: "<?php echo base_url("index.php/cnm_educacion/traercedula") ?>",
      minLength: 3
      });
...
var cedula_comp = $("#cedula").val();
	...
	$.getJSON("<?= base_url('index.php/cnm_educacion/get_datos') ?>/"+$("#cedula").val(),function(data){
...
$('#porcent_tasa_m').val("");
            ...
            $('#numero_acta_comp').keypress(function(e){
	
	var keynum = window.event ? window.event.keyCode : e.which;
	keynum2="";
	var info=$('#numero_acta_comp').val();
...
return /\d/.test(String.fromCharCode(keynum));
 ...
 $('#numero_acta_comp').change(function(){
num_acta = document.getElementById("numero_acta_comp").value;
 	    if( !(/[A-z-\/\*\,\.\ \;\:\{\}\[\]\^\`\¨\´\+\~\°\|\¬\!\¡\'\?\¿\=\)\(\&\%\$\#\"\<\>\Ñ\ñ\+]/.test(num_acta)) )
		{}
  else{
$('#numero_acta_comp').val("");
  }
});
