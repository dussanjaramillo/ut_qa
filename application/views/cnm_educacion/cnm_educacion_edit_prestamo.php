...
<center>
<h2>Registro Cartera Prestamo Educativo</h2>
...
<td><input type="text" id="fecha_activacion" name="fecha_activacion" style="width : 84%;" readonly="readonly" value="<?=$detalleCart["FECHA_ACTIVACION"]?>"></td>
    ...
    <td><input type="text" id="valor_deuda" name="valor_deuda" style="width : 91%;" onchange ="presubmit();" required="required" value="<?=number_format($detalleCart["VALOR_DEUDA"], 0, ',', '.')?>" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td>Plazo</td>
     <td><input type="text" id="plazo" name="plazo" style="width : 15%;" required="required" onchange ="presubmit();" value="<?=$detalleCart["PLAZO_CUOTAS"]?>">
    	...
    	<?php
          ...
          echo form_dropdown('plazo_id', $selectplazo,$detalleCart["COD_PLAZO"],'id="plazo_id" style="width : 75%;" onchange ="presubmit();" class="chosen" data-placeholder="seleccione..." ');
    ...
    {?>
    	    	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" onchange ="presubmit();" style="width : 15%;" value="<?=$detalleCart["VALOR_T_CORRIENTE"]?>">%
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,$detalleCart["TIPO_T_F_CORRIENTE"],'onchange ="presubmit();" id="aplica_tasa_c" style="width : 30%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,$detalleCart["TIPO_T_V_CORRIENTE"],'onchange ="presubmit();" id="aplica_tasa_c" style="width : 30%;" class="chosen" data-placeholder="seleccione..." ');
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td><input type="text" id="id_codeudor" name="id_codeudor" style="width : 91%;" required="required" value="<?=$detalleCart["ID_CODEUDOR"]?>"></td>
    <td>&nbsp;</td>
    <td>Nombre Codeudor&nbsp&nbsp&nbsp&nbsp&nbsp</td>
    <td><input type="text" id="nombre_codeudor" name="nombre_codeudor" style="width : 91%;" required="required" value="<?=$detalleCart["NOMBRE_CODEUDOR"]?>" onkeypress ="escape(this);" onblur = "escape(this);" onkeyup = "escape(this);"></td>
    <td>&nbsp;</td>
  </tr> 
  <tr><td>&nbsp;</td>	</tr> 
        <tr>
