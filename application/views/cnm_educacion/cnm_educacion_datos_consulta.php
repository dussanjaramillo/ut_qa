...
<center><h3>EDUCATIVO SANCIÓN</h3></center>
</br>
...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_educacion/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_educacion/edit') ?>" method="post" >
