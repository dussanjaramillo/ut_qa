...
<center>
<h2>Consulta Cartera Educativo Sanción</h2>
...
<table width="780" border="0">
 ...
 <td><input type="text" id="tipo_cartera" style="width : 91%;" readonly="readonly" value="<?=$carteras["NOMBRE_CARTERA"]?>"></td>
    ...
    <td>&nbsp;</td>
      ...
      <tr>
    <td>&nbsp;</td>	
    <td><b>Fecha Acta de Compromiso</td>
<td><input type="text" id="fecha_acta_compromiso" name="fecha_acta_compromiso" style="width : 91%;" readonly="readonly" value="<?=$carteras["FECHA_ACTA_COMP"]?>"></td>
    <td>&nbsp;</td>
    <td><b>Número Acta Compromiso</td>
    <td><input type="text" id="numero_acta_comp"  name="numero_acta_comp"style="width : 91%;" readonly="readonly" value="<?=$carteras["NUM_ACTA_COMP"]?>"></td>
  	<td>&nbsp;</td>
  </tr>
