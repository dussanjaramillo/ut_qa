...
<td><input type="text" id="fecha_activacion" name="fecha_activacion" style="width : 84%;" readonly="readonly"></td>
    ...
    <td><input type="text" id="valor_deuda" name="valor_deuda" style="width : 91%;" required="required" onchange ="presubmit();" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<?php
          ...
          echo form_dropdown('combo_tipo_tasa_corriente', $selecttipotasa,'','id="combo_tipo_tasa_corriente" onchange ="presubmit();" readonly="readonly" disabled="disabled" style="width : 34%;" class="chosen" data-placeholder="seleccione..." ');
    	...
    	<input type="text" id="porcent_tasa_c" name="porcent_tasa_c" style="width : 15%;" onchange ="presubmit();" readonly="readonly" disabled="disabled">%
    	<?php
          ...
          echo form_dropdown('aplica_tasa_c', $selecttasacorriente,'','id="aplica_tasa_c" style="width : 30%;" onchange ="presubmit();" readonly="readonly" disabled="disabled" class="chosen" data-placeholder="seleccione..." ');
    ...
    <td>
    	...
    	<input type="text" id="porcent_tasa_m" style="width : 15%;" readonly="readonly" disabled="disabled">%
    	<?php
...
<tr><td>&nbsp;</td>	</tr>
   ...
   <td><input type="text" id="id_codeudor" name="id_codeudor" style="width : 91%;" required="required"></td>
    ...
    <td><input type="text" id="nombre_codeudor" name="nombre_codeudor" style="width : 91%;" required="required" onkeypress ="escape(this);" onblur = "escape(this);" onkeyup = "escape(this);"></td>
    <td>&nbsp;</td>
  </tr> 
  <tr><td>&nbsp;</td></tr> 
             <tr>
...
<tr><td>&nbsp;</td>	</tr>
    ...
    <td>&nbsp;</td>	
    <td>&nbsp;</td>	
    <td><input type="checkbox" id="t_i_c">&nbspModificar Tasa de Interés Corriente</td>
    <td>&nbsp;</td>	
    <td><input type="checkbox" id="t_i_m">&nbspModificar Tasa de Interés Mora</td>
    <td>&nbsp;</td>	
  	<td>&nbsp;</td>
  </tr> 
  <tr><td>&nbsp;</td>	</tr> 
