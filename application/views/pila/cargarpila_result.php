...
<div class="center-form-large">
    <h2 align="center">Resultado Cargue Pila</h2>
    <?php if (!isset($archivo)) $archivo = ''; ?>
    <?php $oculto = array('archivo' => $archivo) ?>
    <?php echo form_open("pila/exporta", '', $oculto) ?>
    <table align="center">
        <tr align="center">
            <td align="center">
                <textarea style="width: 700px; height: 300px;" name="errors"><?php
                    ...
                    echo trim("----------------------------------------------------") . "\r\n";
                    ?><?php
                    if (sizeof($errores_totales) > 0) {
                        foreach ($errores_totales as $key => $value2) {
                            if (sizeof($value2) > 0) {
                    ...
                    echo trim("----------------------------------------------------") . "\r\n";
                    ?><?php
                    echo trim("Número total lineas cargadas: " . $numlineas_totales) . "\r\n";
        ...
        <tr align="center">
            <td align="center">
                <?php echo anchor('pila/pilaadd', '<i class="icon-remove"></i> Regresar', 'class="btn"'); ?>
