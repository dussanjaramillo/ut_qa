...
<form id="detalle_cartera" action="<?= base_url('index.php/cnm_convenio/detalle') ?>" method="post" >
    <input type="hidden" id="id_cartera" name="id_cartera">
</form>
<form id="edicion_cartera" action="<?= base_url('index.php/cnm_convenio/edit') ?>" method="post" >
