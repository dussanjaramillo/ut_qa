...
<center>
<h2>Registro Cartera Convenios</h2>
...
<table width="780" class="tabla2">
  ...
  <tr>
    ...
    <td><input type="text" id="cod_empresa" name="cod_empresa" style="width : 91%;" required="required"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <tr>
	<td>&nbsp;</td>
    <td>Razón Social&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td>
    <td><input type="text" id="razon_social" style="width : 91%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Sigla</td>
    <td><input type="text" id="sigla" style="width : 91%;" readonly="readonly"></td>
    <td>&nbsp;</td>
  </tr>
    <tr>
	<td>&nbsp;</td>
    ...
    <td><input type="text" id="correo_electronico" style="width : 91%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Regional</td>
...
<table width="780" border="0">
    ...
    <td><input type="text" id="fecha_suscripcion" name="fecha_suscripcion" style="width : 87%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="id_deuda" name="id_deuda" style="width : 91%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Número de Convenio</td>
    <td><input type="text" id="nro_convenio" name="nro_convenio" style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
      <tr>
    <td>&nbsp;</td>	
    <td>Fecha Acta de Liquidación</td>
    <td><input type="text" id="fecha_acta_liq" name="fecha_acta_liq" style="width : 87%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>No Acta de Liquidación</td>
    <td><input type="text" id="nro_acta_liq" name="nro_acta_liq" style="width : 91%;"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="termino_convenio" name="termino_convenio" style="width : 87%;" readonly="readonly"></td>
    <td>&nbsp;</td>
    <td>Fecha Max.Pago Reintegro</td>
    <td><input type="text" id="fecha_max_reint" name="fecha_max_reint" style="width : 87%;" readonly="readonly"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="valor_convenio" name="valor_convenio" style="width : 91%;" maxlength="20" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>Aporte SENA</td>
	<td><input type="text" id="aporte_sena" name="aporte_sena" style="width : 91%;" maxlength="20" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
  </tr>
    ...
    <td><input type="text" id="valor_rendimientos" name="valor_rendimientos" readonly="readonly" style="width : 91%;" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
    <td>Valor del Reintegro</td>
    <td><input type="text" id="valor_reintegro" name="valor_reintegro" style="width : 91%;" required="required" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);" onchange ="rendimiento(this);"></td>
    <td>&nbsp;</td>
  </tr>
  
  <tr>
    <td>&nbsp;</td>	
    <td>Inicio de Rendimientos</td>
    <td><input type="text" id="rendimientos_ini" name="rendimientos_ini" style="width : 87%;" readonly="readonly" onchange ="rendimiento(this);"></td>
  	<td>&nbsp;</td>
    <td>Fin de Rendimientos</td>
    <td><input type="text" id="rendimientos_fin" name="rendimientos_fin" style="width : 87%;" readonly="readonly" onchange ="rendimiento(this);"></td>
  	<td>&nbsp;</td>
  </tr>
    ...
    <td><?php
        ...
        ?></td>
    <td>&nbsp;</td>
    <td>Tasa de Rendimientos</td>
    <td><input type="text" id="tasa_rendimientos" name="tasa_rendimientos" style="width : 91%;" required="required" onchange ="rendimiento(this);"></td>
   	<td>&nbsp;</td>
  	</tr>
    ...
    <td>&nbsp;</td>	
    <td>Valor Deuda</td>
    <td><input type="text" id="valor_deuda" name="valor_deuda" readonly="readonly" style="width : 91%;" onkeypress ="num(this);" onblur = "num(this);" onkeyup = "num(this);"></td>
    <td>&nbsp;</td>
<td>Forma de Pago</td>
    <td>
    	<?php
          ...
          echo form_dropdown('forma_pago_id', $selectformapago,'2','id="forma_pago_id" readonly="readonly" disabled="disabled" style="width : 97%;" class="chosen" data-placeholder="seleccione..." ');
...
function confirmSubmit() {
 ...
 function rendimiento(c){
  ...
  if($('#tasa_rendimientos').val()!=""&&$('#rendimientos_ini').val()!=""&&$('#rendimientos_fin').val()!=""&&$('#valor_reintegro').val()!="")
  {
  		$.getJSON("<?= base_url('index.php/cnm_convenio/get_rendimientos') ?>/"+$("#tasa_rendimientos").val()+"/"+$("#rendimientos_ini").val()+"/"+$("#rendimientos_fin").val()+"/"+$("#valor_reintegro").val(),function(data){
  	$('#valor_rendimientos').val(data.RENDIMIENTOS);
  	$('#valor_deuda').val(data.DEUDA);
  });
 }
}
 function num(c){
...
$( "#rendimientos_ini").datepicker({
	
	showOn: 'button',
	buttonText: 'Fecha Inicio Rendimiento',
	buttonImage: 'http://jqueryui.com/resources/demos/datepicker/images/calendar.gif',
	buttonImageOnly: true,
	numberOfMonths: 1,
	changeMonth: true,
	...
	$("#rendimientos_fin").datepicker("option", "minDate", selectedDate)
	}
});

$( "#rendimientos_fin").datepicker({
	
	showOn: 'button',
	buttonText: 'Fecha Fin Rendimiento',
	buttonImage: 'http://jqueryui.com/resources/demos/datepicker/images/calendar.gif',
	buttonImageOnly: true,
	numberOfMonths: 1,
	changeMonth: true,
	...
	dateFormat: 'yy-mm-dd',
	 onClose: function(selectedDate) {
	$("#rendimientos_ini").datepicker("option", "maxDate", selectedDate)
	}
});
