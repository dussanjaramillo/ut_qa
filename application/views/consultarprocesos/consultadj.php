<!--
    /**
     * Formulario que muestra los Procesos de Direccion Juridica
     * En este formulario se muestra todos los procesos de direccion Juridica
...
<h1>Procesos Direcci&oacute;n Jur&iacute;dica</h1>
<br>
    ...
    <tbody>
        ...
        foreach ($datos as $col) {
            ...
            <tr>
                ...
                <td><?php echo $col['TIPO_PROCESO']; ?></td>
                <td align="center"><button at="<?php echo $col['COD_TIPO_PROCESO']; ?>" class="btn btn-info"> <i class='fa fa-image' ></i> Ver Imagen </button></td>
...
<form action= "<?php echo base_url('index.php/consultarprocesos/'); ?>" method="post">
    <button type='submit' name='daf' id='admon' class='btn btn-default' style="float: right" ><i class='fa fa-arrow-circle-left' ></i> Volver</button>    
</form>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width: 1250px;height: 600px; top: 10px; left: 350px; overflow: auto" data-keyboard="false" data-backdrop="static"> 
    ...
    <div class="modal-body"> 
        <form action="<?php echo "url"; ?>" >
            <center>
                <a href="index.php" target="_blank"><img class="magnify" id="imgff" src="<?php echo base_url(); ?>img/ff.png" ></a>
                <a id="link1" name="link1" href="index.php" target="_blank"><img class="magnify" id="imgff1" src="<?php echo base_url(); ?>img/ff.png" ></a>
            </center>    
    </div>

    <div class="modal-footer">

        <button type="submit" href="#" onclick="location.href = '<?php echo base_url('index.php/consultarprocesos/consultadj'); ?>';" class="btn btn-warning" data-dismiss="modal" id="cancelar"><i class="fa fa-reply-all"> Cerrar</i></button>
