...
echo form_open_multipart("ejecutoriaactoadmin/documento_juridico", $attributes);
?>
...
Envi&oacute; De Documento Para Cobro Coactivo
<br>
<div >            
    ...
    <?php if(isset($post['cod_revocatoria'])){ ?>
