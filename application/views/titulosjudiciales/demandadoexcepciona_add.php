...
<div style="background: #f0f0f0; width: 700px; margin: auto; overflow: hidden">
    ...
    echo form_open("procesojudicial/Agregar_Demandado_Excepciona", $attributes);
    ?>       
    <?php
    ...
    <div style="overflow: hidden; width: 80%; margin: 0 auto">
        <h2 class="text-center">Registrar si Demandado Excepciona</h2>
    </div>
    <div style="overflow: hidden; width: 50%; margin: 0 auto">
        <br>     
        <div class="columna_derecha"> 
            <input type="radio" checked="checked"  id="opc_res" name="opc_res" value="no_excepciona" >No Excepciona 
        </div>
        <div class="columna_izquierda">            
            <input type="radio"  id="opc_res1" name="opc_res" value="excepciona">Excepciona
        </div>
    </div>
    <br><br>
    <div style="overflow: hidden; width: 40%; margin: 0 auto">
        <div class="text-center">
            <p class="pull-right">
                <?php echo anchor('procesojudicial/Lista_Demandado_Excepciona', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
                <?php
                $data = array(
                    'name' => 'button',
                    'id' => 'submit-button',
