...
<div class="center-form-large">
    ...
    echo form_open_multipart("procesojudicial/Agregar_Entregar_Liquidacion", $attributes);
    ...
    <h2>Cargar soporte de entrega de la Liquidación</h2>
    <br>
    <div class="controls ">            
        <div class="span4">      
    ...
    <div class="controls controls-row">
        <p class="pull-right">
            <br><br>            
            <?php echo anchor('procesojudicial/Lista_Entregar_Liquidacion', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
            <?php
            $data = array(
                'name' => 'button',
                'id' => 'submit-button',
