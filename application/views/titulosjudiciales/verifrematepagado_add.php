...
<div style="background: #f0f0f0; width: 700px; margin: auto; overflow: hidden">
    ...
    echo form_open("procesojudicial/Agregar_PagoRemateBienes", $attributes);
    ?>       
    <?php
    ...
    <div style="overflow: hidden; width: 80%; margin: 0 auto">
        <h2 class="text-center">Verificar Remate de Bienes</h2>
    </div>
    <div style="overflow: hidden; width: 60%; margin: 0 auto">
        <br>     
        <div class="columna_derecha"> 
            <input type="radio" checked="checked"  id="opc_res" name="opc_res" value="no_hay" >No hubo Pago 
        </div>
        <div class="columna_izquierda">            
            <input type="radio"  id="opc_res1" name="opc_res" value="si_hay">Se Registro Pago
        </div>
    </div>
    <br><br>
