...
<div class="center-form-large">
    ...
    echo form_open_multipart("procesojudicial/Carga_Verificar_Proferimiento", $attributes);
    ...
    <h2>Cargar auto que ordena seguir adelante con la ejecución</h2>
    <br>
    <div class="controls ">            
        <div class="span4">      
            <div style="overflow: hidden; clear: both; margin:240px 0; width: 95%; margin: 0 auto; text-align: center">
                <?php
                $data = array(
                    'name' => 'userfile',
                    'id' => 'imagen',
    ...
    <div class="controls controls-row">
        <p class="pull-right">
            <br><br>            
            <?php echo anchor('procesojudicial/Lista_Verificar_Proferimiento', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
            <?php
            $data = array(
                'name' => 'button',
                'id' => 'submit-button',
