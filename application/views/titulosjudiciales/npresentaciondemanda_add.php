...
<div style="background: #f0f0f0; width: 700px; margin: auto; overflow: hidden">
    ...
    echo form_open("procesojudicial/Agregar_Nueva_Demanda", $attributes);
    ?>       
    <?php
    ...
    <div style="overflow: hidden; width: 72%; margin: 0 auto">
        ...
        if ($campos) {
            ...
            <div class="text-center">
                <p class="pull-right">
                    <br>
                    <?php echo anchor('procesojudicial/Lista_Nueva_Demanda', '<i class="icon-remove"></i> Cancelar', 'class="btn"'); ?>
                    <?php
                    $data = array(
                        'name' => 'button',
                        'id' => 'submit-button',
...
<?php } else { ?>
    <div class="text-center"><?php
        echo anchor('procesojudicial/Lista_Nueva_Demanda', '<i class="icon-remove"></i> Regresar', 'class="btn"');
    }
    ?>
    <?php echo form_close(); ?>
    <script>
