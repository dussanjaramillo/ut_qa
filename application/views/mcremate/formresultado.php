...
<div class="span10" style="alignment-adjust: central">
            ...
            <div id="Resultado" class="Resultado span10" style="alignment-adjust: central">
                <br><br>
                <?php
                echo form_label('<h3>¿Resultado de la Diligencia?</h3>', 'recibio_documento');
                $data = array(
                    'name' => 'recibio_documento',
                    'id' => 'recibio_documento1',
                    'value' => 'si',
...
<script>
    ...
    function redireccionar(valor) {
        $(".preload, .load").show();
        if (valor == 'S') {
            $('#respuesta').val(<?php echo REMATE_DESIERTO_1; ?>);
            $("#form1").submit();
        } else {
            $('#respuesta').val(<?php echo REMATE_ADJUDICADO; ?>);
            $("#form1").submit();
        }
    }
