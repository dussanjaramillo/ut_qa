<form id="form_volver" action="<?= base_url('index.php/mcremate/Gestion_EliminarPlantillas') ?>" method="post" >
...
<form id="form1" action="<?= base_url('index.php/mcremate/Gestion_EliminarSoporte') ?>" method="post" >
...
echo form_open_multipart("mcremate/Generar_Expediente", $attributes);
echo form_hidden('cod_coactivo', $cod_coactivo);
echo form_hidden('cod_respuesta', $cod_respuesta);
?>  
<center>
    <h2>Medidas Cautelares - Remate</h2>
