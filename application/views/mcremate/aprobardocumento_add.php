        ...
        if (informacion == "" || nombre == "" || comentarios == "") {
            ...
            $.post(url, {nombre2: nombre, nombre: nombre_archivo, informacion: informacion, opcion: "1", cod_avaluo: avaluo})
                    .done(function(msg) {
                        ...
                        $.post(url_documentos, {cod_avaluo: avaluo, encabezado: encabezado, abogado: abogado, coordinador: coordinador, cod_coactivo: coactivo, estado: estado, secretario: secretario, nombre_documento: nombre_archivo, comentarios: comentarios})
                                .done(function(msg) {
