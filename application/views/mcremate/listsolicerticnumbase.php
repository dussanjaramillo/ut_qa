...
function dataTable(){
    ...
    $('#tablaq').dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>index.php/mcremate/datatableSoliCertiCnumOnBase",          
        "aoColumns": [  
               ...
               //Link Gestion
                 { "sClass": "center", "mData": null,
                   ...
                   "fnRender": function (oObj) {
                      return " <a href='javascript:void(0)' onclick='window.location = \"<?=base_url()?>index.php/mcremate/formcomirema/" + oObj.aData.COD_AVALUO + "\"' class=\"btn btn-small\" data-toggle=\"modal\" data-target=\"#modal\" data-keyboard=\"false\" data-backdrop=\"static\" title=\"Fiscalizaciones\"><i class=\"fa fa-eye-slash\"></i></a>";
                     }
                 }
           ]
