<form id="form_volver" action="<?= base_url('index.php/traslado/Gestion_EliminarPlantillas') ?>" method="post" >
     <input type="hidden" id="cod_fiscalizacion" name="cod_fiscalizacion" value="<?php echo $cod_fiscalizacion; ?>" readonly>
</form>
<form id="form1" action="<?= base_url('index.php/traslado/Gestion_EliminarSoporte') ?>" method="post" >
        ...
        <table class="table table-bordered" width="100%" border="1" align="center">
            ...
            for ($i = 0; $i < sizeof($archivos); $i++) {
                ...
                <tr>
                    ...
                    <td><center><?php echo anchor(base_url() . $archivos[$i]['RUTA_DOCUMENTO'], '<i class="fa fa-eye"></i>', 'class="btn btn-default"'); ?></center></td>
                </tr>
                <?php
            }
            ?>
